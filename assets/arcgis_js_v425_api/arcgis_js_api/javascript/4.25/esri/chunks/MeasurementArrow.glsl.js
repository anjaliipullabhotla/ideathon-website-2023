...
a=>a.width));b.attributes.add(c.VertexAttribute.POSITION,"vec3");b.attributes.add(c.VertexAttribute.NORMAL,"vec3");b.attributes.add(c.VertexAttribute.UV0,"vec2");b.attributes.add(c.VertexAttribute.AUXPOS1,"float");b.varyings.add("vtc","vec2");b.varyings.add("vlength","float");b.varyings.add("vradius","float");g.code.add(f.glsl`void main(void) {
