...
//>>built
define("exports ../../../../../../chunks/vec3 ../../../../../../chunks/vec3f64 ../../../../../../chunks/vec4 ../../../../../../chunks/vec4f64 ./PhysicallyBasedRenderingParameters.glsl ../../shaderModules/Float3PassUniform ../../shaderModules/Float4PassUniform ../../shaderModules/interfaces".split(" "),function(l,m,r,c,t,n,p,d,g){const q=r.create(),e=t.create();l.EvaluateAmbientLighting=function(f,h){f=f.fragment;const k=void 0!==h.lightingSphericalHarmonicsOrder?h.lightingSphericalHarmonicsOrder:
2;0===k?(f.uniforms.add(new p.Float3PassUniform("lightingAmbientSH0",(b,a)=>m.set(q,a.lighting.sh.r[0],a.lighting.sh.g[0],a.lighting.sh.b[0]))),f.code.add(g.glsl`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
