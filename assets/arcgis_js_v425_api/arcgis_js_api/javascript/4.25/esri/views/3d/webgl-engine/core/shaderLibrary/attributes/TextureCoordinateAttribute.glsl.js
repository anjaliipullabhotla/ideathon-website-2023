...
vuv0 = uv0;
vuvRegion = uvRegion;
}`);break;default:f.neverReached(e.textureCoordinateType);case b.TextureCoordinateAttributeType.None:a.vertex.code.add(c.glsl`void forwardTextureCoordinates() {}`);case b.TextureCoordinateAttributeType.COUNT:}};Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});