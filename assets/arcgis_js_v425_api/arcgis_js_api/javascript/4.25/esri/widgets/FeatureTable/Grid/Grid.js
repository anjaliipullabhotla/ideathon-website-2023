...
//>>built
define("../../../chunks/_rollupPluginBabelHelpers ../../../chunks/tslib.es6 ../../../core/events ../../../core/HandleOwner ../../../core/maybe ../../../core/reactiveUtils ../../../core/accessorSupport/decorators/property ../../../core/arrayUtils ../../../core/accessorSupport/decorators/cast ../../../core/accessorSupport/decorators/subclass ../../Widget ./GridViewModel ../../support/widgetUtils ../../support/decorators/messageBundle ../../support/jsxFactory".split(" "),function(ib,y,Ia,ae,Ja,Ka,z,
mg,be,ce,de,ee,fe,ge,Y){function bc(b){requestAnimationFrame(function(){cc?cc(b):(jb||(jb=new Promise(a=>{kb=a}),"complete"===document.readyState?kb():document.addEventListener("readystatechange",()=>{"complete"===document.readyState&&kb()})),jb.then(function(){b&&b()}))})}function lb(b,a){for(let c in a)null===c?b.style.removeProperty(c):b.style.setProperty(c,a[c])}function dc(b,a){return(b=window.getComputedStyle(b).getPropertyValue(a))?b.trim():""}function ec(b){mb=b&&b.shimcssproperties?!1:La||
!(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/)||!window.CSS||!CSS.supports||!CSS.supports("box-shadow","0 0 0 var(--foo)"))}function ka(b,a){if(b&&he.test(b)||"//"===b)return b;if(void 0===Ma){Ma=!1;try{const c=new URL("b","http://a");c.pathname="c%20d";Ma="http://a/c%20d"===c.href}catch(c){}}a||(a=document.baseURI||window.location.href);if(Ma)try{return(new URL(b,a)).href}catch(c){return b}E||(E=document.implementation.createHTMLDocument("temp"),E.base=E.createElement("base"),E.head.appendChild(E.base),
E.anchor=E.createElement("a"),E.body.appendChild(E.anchor));E.base.href=a;E.anchor.href=b;return E.anchor.href||b}function nb(b,a){return b.replace(ie,function(c,d,e,f){return d+"'"+ka(e.replace(/["']/g,""),a)+"'"+f})}function ob(b){return b.substring(0,b.lastIndexOf("/")+1)}function fc(b){b=nb((b.body?b.body:b).textContent,b.baseURI);const a=document.createElement("style");a.textContent=b;return a}function je(b){b=b.trim().split(/\s+/);const a=[];for(let g=0;g<b.length;g++){var c=a,d=c.push,e;var f=
b[g];if(e=O.import(f)){if(void 0===e._styles){f=[];f.push(...pb(e));const h=e.querySelector("template");h&&f.push(...qb(h,e.assetpath));e._styles=f}e=e._styles}else console.warn("Could not find style data in module named",f),e=[];d.call(c,...e)}return a}function qb(b,a){if(!b._styles){const c=[],d=b.content.querySelectorAll("style");for(let e=0;e<d.length;e++){let f=d[e],g=f.getAttribute("include");g&&c.push(...je(g).filter(function(h,k,l){return l.indexOf(h)===k}));a&&(f.textContent=nb(f.textContent,
a));c.push(f)}b._styles=c}return b._styles}function ke(b){return(b=O.import(b))?pb(b):[]}function pb(b){const a=[];b=b.querySelectorAll("link[rel\x3dimport][type~\x3dcss]");for(let d=0;d<b.length;d++){var c=b[d];if(c.import){const e=c.import;if((c=c.hasAttribute("shady-unscoped"))&&!e._unscopedStyle){const f=fc(e);f.setAttribute("shady-unscoped","");e._unscopedStyle=f}else e._style||(e._style=fc(e));a.push(c?e._unscopedStyle:e._style)}}return a}function J(b){let a=b.indexOf(".");return-1===a?b:b.slice(0,
a)}function la(b){if(Array.isArray(b)){let a=[];for(let c=0;c<b.length;c++){let d=b[c].toString().split(".");for(let e=0;e<d.length;e++)a.push(d[e])}return a.join(".")}return b}function gc(b){return Array.isArray(b)?la(b).split("."):b.toString().split(".")}function C(b,a,c){a=gc(a);for(let d=0;d<a.length;d++){if(!b)return;b=b[a[d]]}c&&(c.path=a.join("."));return b}function hc(b,a,c){let d=gc(a),e=d[d.length-1];if(1<d.length){for(a=0;a<d.length-1;a++)if(b=b[d[a]],!b)return;b[e]=c}else b[a]=c;return d.join(".")}
function ic(b){return Na[b]||(Na[b]=0>b.indexOf("-")?b:b.replace(le,a=>a[1].toUpperCase()))}function Oa(b){return Na[b]||(Na[b]=b.replace(me,"-$1").toLowerCase())}function jc(b,a){let c=a.parentInfo&&jc(b,a.parentInfo);if(c)for(let d=c.firstChild,e=0;d;d=d.nextSibling){if(a.parentIndex===e++)return d}else return b}function ne(b,a,c){b=b._methodHost||b;return function(d){if(b[c])b[c](d,d.detail);else console.warn("listener method `"+c+"` not defined")}}function rb(b,a,c){let d=b[a];if(!d)d=b[a]={};
else if(!b.hasOwnProperty(a)&&(d=b[a]=Object.create(b[a]),c))for(let e in d)for(b=d[e],a=d[e]=Array(b.length),c=0;c<b.length;c++)a[c]=b[c];return d}function ma(b,a,c,d,e,f){if(a){let h=!1;const k=na++;for(let l in c){var g=e?J(l):l;if(g=a[g])for(let m=0,n=g.length,p;m<n&&(p=g[m]);m++)p.info&&p.info.lastRun===k||e&&!sb(l,p.trigger)||(p.info&&(p.info.lastRun=k),p.fn(b,l,c,d,p.info,e,f),h=!0)}return h}return!1}function sb(b,a){if(a){let c=a.name;return c==b||!(!a.structured||0!==c.indexOf(b+"."))||!(!a.wildcard||
0!==b.indexOf(c+"."))}return!0}function kc(b,a,c,d,e){a="string"===typeof e.method?b[e.method]:e.method;c=e.property;a?a.call(b,b.__data[c],d[c]):e.dynamicFn||console.warn("observer method `"+e.method+"` not defined")}function lc(b,a,c,d){c={value:c,queueProperty:!0};d&&(c.path=d);q(b).dispatchEvent(new CustomEvent(a,{detail:c}))}function oe(b,a,c,d,e,f){f=(d=(f?J(a):a)!=a?a:null)?C(b,d):b.__data[a];d&&void 0===f&&(f=c[a]);lc(b,e.eventName,f,d)}function pe(b,a,c,d,e){c=b.__data[a];Pa&&(c=Pa(c,e.attrName,
"attribute",b));b._propertyToAttribute(a,e.attrName,c)}function qe(b){let a=b.constructor.__orderedComputedDeps;if(!a){a=new Map;const d=b[t.COMPUTE];let {counts:e,ready:f,total:g}=re(b);for(var c;c=f.shift();)a.set(c,a.size),(c=d[c])&&c.forEach(h=>{h=h.info.methodInfo;--g;0===--e[h]&&f.push(h)});0!==g&&console.warn(`Computed graph for ${b.localName} incomplete; circular?`);b.constructor.__orderedComputedDeps=a}return a}function re(b){const a=b.__computeInfo,c={};b=b[t.COMPUTE];const d=[];let e=0;
for(let f in a){const g=a[f];e+=c[f]=g.args.filter(h=>!h.literal).length+(g.dynamicFn?1:0)}for(let f in b)a[f]||d.push(f);return{counts:c,ready:d,total:e}}function mc(b,a,c,d,e){a=tb(b,a,c,d,e);if(a===oa)return!1;e=e.methodInfo;if(b.__dataHasAccessor&&b.__dataHasAccessor[e])return b._setPendingProperty(e,a,!0);b[e]=a;return!1}function ub(b,a,c,d,e,f,g){c.bindings=c.bindings||[];d={kind:d,target:e,parts:f,literal:g,isCompound:1!==f.length};c.bindings.push(d);if(d.target&&"attribute"!=d.kind&&"text"!=
d.kind&&!d.isCompound&&"{"===d.parts[0].mode){let {event:n,negate:p}=d.parts[0];d.listenerEvent=n||Oa(e)+"-changed";d.listenerNegate=p}c=a.nodeInfoList.length;for(g=0;g<d.parts.length;g++){var h=d.parts[g];h.compoundIndex=g;e=b;f=a;var k=d,l=h,m=c;if(!l.literal)if("attribute"===k.kind&&"-"===k.target[0])console.warn("Cannot set attribute "+k.target+' because "-" is not a valid attribute starting character');else for(h=l.dependencies,k={index:m,binding:k,part:l,evaluator:e},l=0;l<h.length;l++)m=h[l],
...
(c=g.__dataCompoundStorage[h.target],c[k.compoundIndex]=a,a=c.join("")),"attribute"===h.kind||"textContent"!==h.target&&("value"!==h.target||"input"!==g.localName&&"textarea"!==g.localName)||(a=void 0==a?"":a),Pa&&(a=Pa(a,h.target,h.kind,g)),"attribute"==h.kind?b._valueToNodeAttribute(g,a,h.target):(h=h.target,g.__isPropertyEffectsClient&&g.__dataHasAccessor&&g.__dataHasAccessor[h]?g[t.READ_ONLY]&&g[t.READ_ONLY][h]||g._setPendingProperty(h,a)&&b._enqueueClient(g):b._setUnmanagedPropertyToNode(g,h,
a))))}function te(b,a,c){if(c.listenerEvent){let d=c.parts[0];b.addEventListener(c.listenerEvent,function(e){var f=c.target,g=d.source,h=d.negate;let k=e.detail,l=k&&k.path;l?(g+=l.slice(f.length),e=k&&k.value):e=e.currentTarget[f];a[t.READ_ONLY]&&a[t.READ_ONLY][g]||!a._setPendingPropertyOrPath(g,h?!e:e,!0,!!l)||k&&k.queueProperty||a._invalidateProperties()})}}function oc(b,a,c,d,e,f){f=a.static||f&&("object"!==typeof f||f[a.methodName]);e={methodName:a.methodName,args:a.args,methodInfo:e,dynamicFn:f};
for(let g=0,h;g<a.args.length&&(h=a.args[g]);g++)h.literal||b._addPropertyEffect(h.rootProperty,c,{fn:d,info:e,trigger:h});f&&b._addPropertyEffect(a.methodName,c,{fn:d,info:e});return e}function tb(b,a,c,d,e){d=b._methodHost||b;let f=d[e.methodName];if(f)return b=b._marshalArgs(e.args,a,c),b===oa?oa:f.apply(d,b);e.dynamicFn||console.warn("method `"+e.methodName+"` not defined")}function pc(b){let a="";for(let c=0;c<b.length;c++)a+=b[c].literal||"";return a}function vb(b){var a=b.match(/([^\s]+?)\(([\s\S]*)\)/);
return a?(b={methodName:a[1],static:!0,args:ue},a[2].trim()?(a=a[2].replace(/\\,/g,"\x26comma;").split(","),ve(a,b)):b):null}function ve(b,a){a.args=b.map(function(c){c=nc(c);c.literal||(a.static=!1);return c},this);return a}function nc(b){b=b.trim().replace(/&comma;/g,",").replace(/\\(.)/g,"$1");let a={name:b,value:"",literal:!1},c=b[0];"-"===c&&(c=b[1]);"0"<=c&&"9">=c&&(c="#");switch(c){case "'":case '"':a.value=b.slice(1,-1);a.literal=!0;break;case "#":a.value=Number(b),a.literal=!0}a.literal||
(a.rootProperty=J(b),a.structured=0<=b.indexOf("."),a.structured&&(a.wildcard=".*"==b.slice(-2),a.wildcard&&(a.name=b.slice(0,-2))));return a}function qc(b,a,c){b=C(b,c);void 0===b&&(b=a[c]);return b}function rc(b,a,c,d){d={indexSplices:d};wb&&!b._overrideLegacyUndefined&&(a.splices=d);b.notifyPath(c+".splices",d);b.notifyPath(c+".length",a.length);wb&&!b._overrideLegacyUndefined&&(d.indexSplices=[])}function pa(b,a,c,d,e,f){rc(b,a,c,[{index:d,addedCount:e,removed:f,object:a,type:"splice"}])}function we(b){return b[0].toUpperCase()+
b.substring(1)}function sc(b){if(!(-1<Qa.indexOf(b))&&"touchend"!==b&&xb&&yb&&xe)return{passive:!0}}function tc(b){let a=uc?["click"]:Qa;for(let c=0,d;c<a.length;c++)d=a[c],b?(zb.length=0,document.addEventListener(d,vc,!0)):document.removeEventListener(d,vc,!0)}function Z(b){var a=b.type;return-1<Qa.indexOf(a)?"mousemove"===a?(a=void 0===b.buttons?1:b.buttons,b instanceof window.MouseEvent&&!ye&&(a=ze[b.which]||0),!!(a&1)):0===(void 0===b.button?0:b.button):!1}function Ae(b){if("click"===b.type){if(0===
b.detail)return!0;var a=P(b);if(!a.nodeType||a.nodeType!==Node.ELEMENT_NODE)return!0;a=a.getBoundingClientRect();let c=b.pageX;b=b.pageY;return!(c>=a.left&&c<=a.right&&b>=a.top&&b<=a.bottom)}return!1}function wc(b,a,c){b.movefn=a;b.upfn=c;document.addEventListener("mousemove",a);document.addEventListener("mouseup",c)}function ba(b){document.removeEventListener("mousemove",b.movefn);document.removeEventListener("mouseup",b.upfn);b.movefn=null;b.upfn=null}function P(b){const a=Ra(b);return 0<a.length?
a[0]:b.target}function xc(b){let a=b.type;var c=b.currentTarget.__polymerGestures;if(c&&(c=c[a])){if(!b.__polymerGesturesHandled&&(b.__polymerGesturesHandled={},"touch"===a.slice(0,5))){var d=b.changedTouches[0];"touchstart"===a&&1===b.touches.length&&(A.touch.id=d.identifier);if(A.touch.id!==d.identifier)return;if(!xb&&("touchstart"===a||"touchmove"===a)){d=b.changedTouches[0];var e=b.type;if("touchstart"===e)A.touch.x=d.clientX,A.touch.y=d.clientY,A.touch.scrollDecided=!1;else if("touchmove"===
e&&!A.touch.scrollDecided){A.touch.scrollDecided=!0;e="auto";var f=Ra(b);for(let h=0,k;h<f.length;h++)if(k=f[h],k.__polymerGesturesTouchAction){e=k.__polymerGesturesTouchAction;break}f=!1;var g=Math.abs(A.touch.x-d.clientX);d=Math.abs(A.touch.y-d.clientY);b.cancelable&&("none"===e?f=!0:"pan-x"===e?f=d>g:"pan-y"===e&&(f=g>d));f?b.preventDefault():Sa("track")}}}d=b.__polymerGesturesHandled;if(!d.skip){for(let h=0,k;h<aa.length;h++)k=aa[h],c[k.name]&&!d[k.name]&&k.flow&&-1<k.flow.start.indexOf(b.type)&&
k.reset&&k.reset();for(let h=0,k;h<aa.length;h++)k=aa[h],c[k.name]&&!d[k.name]&&(d[k.name]=!0,k[a](b))}}}function Ab(b,a,c){if(qa[a]){let d=qa[a],e=d.deps,f=d.name,g=b.__polymerGestures;g||(b.__polymerGestures=g={});for(let h=0,k,l;h<e.length;h++)k=e[h],uc&&-1<Qa.indexOf(k)&&"click"!==k||((l=g[k])||(g[k]=l={_count:0}),0===l._count&&b.addEventListener(k,xc,sc(k)),l[f]=(l[f]||0)+1,l._count=(l._count||0)+1);b.addEventListener(a,c);d.touchAction&&yc(b,d.touchAction);return!0}return!1}function Bb(b){aa.push(b);
for(let a=0;a<b.emits.length;a++)qa[b.emits[a]]=b}function yc(b,a){xb&&b instanceof HTMLElement&&G.run(()=>{b.style.touchAction=a});b.__polymerGesturesTouchAction=a}function Cb(b,a,c){a=new Event(a,{bubbles:!0,cancelable:!0,composed:!0});a.detail=c;q(b).dispatchEvent(a);a.defaultPrevented&&(b=c.preventer||c.sourceEvent)&&b.preventDefault&&b.preventDefault()}function Sa(b){a:{for(let a=0,c;a<aa.length;a++){c=aa[a];for(let d=0,e;d<c.emits.length;d++)if(e=c.emits[d],e===b){b=c;break a}}b=null}b.info&&
(b.info.prevent=!0)}function ra(b,a,c,d){a&&Cb(a,b,{x:c.clientX,y:c.clientY,sourceEvent:c,preventer:d,prevent:function(e){return Sa(e)}})}function zc(b,a,c){if(b.prevent)return!1;if(b.started)return!0;c=Math.abs(b.y-c);return 5<=Math.abs(b.x-a)||5<=c}function Db(b,a,c){if(a){var d=b.moves[b.moves.length-2],e=b.moves[b.moves.length-1],f=e.x-b.x,g=e.y-b.y,h=0;if(d){var k=e.x-d.x;h=e.y-d.y}Cb(a,"track",{state:b.state,x:c.clientX,y:c.clientY,dx:f,dy:g,ddx:k,ddy:h,sourceEvent:c,hover:function(){var l=
c.clientX,m=c.clientY;let n=document.elementFromPoint(l,m),p=n;for(;p&&p.shadowRoot&&!window.ShadyDOM;){let r=p;p=p.shadowRoot.elementFromPoint(l,m);if(r===p)break;p&&(n=p)}return n}})}}function Ac(b,a,c){let d=Math.abs(a.clientX-b.x),e=Math.abs(a.clientY-b.y),f=P(c||a);!f||Be[f.localName]&&f.hasAttribute("disabled")||!(isNaN(d)||isNaN(e)||25>=d&&25>=e||Ae(a))||b.prevent||Cb(f,"tap",{x:a.clientX,y:a.clientY,sourceEvent:a,preventer:c})}function Ce(){return Bc(function(){return!0})}function De(){return Ta&&
0<Object.keys(Ta).map(b=>Ta[b]).filter(b=>b.productionMode).length?!0:!1}function Bc(b,a){if("function"===typeof b){var c=Ee.exec(b.toString());if(c)try{b=new Function(c[1])}catch(d){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",d)}return b(a)}}function Fe(){}function Cc(){Ua=!0;requestAnimationFrame(function(){Ua=!1;Ge(Dc);setTimeout(function(){var b=Ec;for(let a=0,c=b.length;a<c;a++)Fc(b.shift())})})}function Ge(b){for(;b.length;)Fc(b.shift())}function Fc(b){const a=b[0],
c=b[1];b=b[2];try{c.apply(a,b)}catch(d){setTimeout(()=>{throw d;})}}function He(b,a,c){Ua||Cc();Dc.push([b,a,c])}function Ie(b,a,c){Ua||Cc();Ec.push([b,a,c])}function Gc(b){b=b.replace(K.comments,"").replace(K.port,"");var a=Hc,c=b;let d=new Ic;d.start=0;d.end=c.length;let e=d;for(let f=0,g=c.length;f<g;f++)if("{"===c[f]){e.rules||(e.rules=[]);let h=e,k=h.rules[h.rules.length-1]||null;e=new Ic;e.start=f+1;e.parent=h;e.previous=k;h.rules.push(e)}else"}"===c[f]&&(e.end=f+1,e=e.parent||d);return a(d,
b)}function Hc(b,a){var c=a.substring(b.start,b.end-1);b.parsedCssText=b.cssText=c.trim();b.parent&&(c=a.substring(b.previous?b.previous.end:b.parent.start,b.start-1),c=Je(c),c=c.replace(K.multipleSpaces," "),c=c.substring(c.lastIndexOf(";")+1),c=b.parsedSelector=b.selector=c.trim(),b.atRule=0===c.indexOf("@"),b.atRule?0===c.indexOf("@media")?b.type=Q.MEDIA_RULE:c.match(K.keyframesRule)&&(b.type=Q.KEYFRAMES_RULE,b.keyframesName=b.selector.split(K.multipleSpaces).pop()):0===c.indexOf("--")?b.type=
Q.MIXIN_RULE:b.type=Q.STYLE_RULE);if(c=b.rules)for(let d=0,e=c.length,f;d<e&&(f=c[d]);d++)Hc(f,a);return b}function Je(b){return b.replace(/\\([0-9a-f]{1,6})\s/gi,function(a,c){a=c;for(c=6-a.length;c--;)a="0"+a;return"\\"+a})}function Jc(b,a,c=""){let d="";if(b.cssText||b.rules){let f=b.rules;var e;if(e=f)e=f[0],e=!(e&&e.selector&&0===e.selector.indexOf("--"));if(e)for(let g=0,h=f.length,k;g<h&&(k=f[g]);g++)d=Jc(k,a,d);else a?a=b.cssText:(a=b.cssText,a=a.replace(K.customProp,"").replace(K.mixinProp,
""),a=a.replace(K.mixinApply,"").replace(K.varApply,"")),(d=a.trim())&&(d="  "+d+"\n")}d&&(b.selector&&(c+=b.selector+" {\n"),c+=d,b.selector&&(c+="}\n\n"));return c}function Eb(b,a){if(!b)return"";"string"===typeof b&&(b=Gc(b));a&&sa(b,a);return Jc(b,Fb)}function Kc(b){!b.__cssRules&&b.textContent&&(b.__cssRules=Gc(b.textContent));return b.__cssRules||null}function sa(b,a,c,d){if(b){var e=!1,f=b.type;if(d&&f===Q.MEDIA_RULE){let g=b.selector.match(Ke);g&&(window.matchMedia(g[1]).matches||(e=!0))}f===
Q.STYLE_RULE?a(b):c&&f===Q.KEYFRAMES_RULE?c(b):f===Q.MIXIN_RULE&&(e=!0);if((b=b.rules)&&!e)for(let g=0,h=b.length,k;g<h&&(k=b[g]);g++)sa(k,a,c,d)}}function Lc(b,a){var c=b.indexOf("var(");if(-1===c)return a(b,"","","");a:{var d=0;for(let g=c+3,h=b.length;g<h;g++)if("("===b[g])d++;else if(")"===b[g]&&0===--d){d=g;break a}d=-1}var e=d;d=b.substring(c+4,e);c=b.substring(0,c);b=Lc(b.substring(e+1),a);let f=d.indexOf(",");if(-1===f)return a(c,d.trim(),"",b);e=d.substring(0,f).trim();d=d.substring(f+1).trim();
return a(c,e,d,b)}function Mc(b){if(void 0!==ta)return ta;if(void 0===b.__cssBuild){var a=b.getAttribute("css-build");if(a)b.__cssBuild=a;else{a:{a="template"===b.localName?b.content.firstChild:b.firstChild;if(a instanceof Comment&&(a=a.textContent.trim().split(":"),"css-build"===a[0])){a=a[1];break a}a=""}if(""!==a){const c="template"===b.localName?b.content.firstChild:b.firstChild;c.parentNode.removeChild(c)}b.__cssBuild=a}}return b.__cssBuild||""}function Le(b){if(b=Gb[b])b._applyShimCurrentVersion=
b._applyShimCurrentVersion||0,b._applyShimValidatingVersion=b._applyShimValidatingVersion||0,b._applyShimNextVersion=(b._applyShimNextVersion||0)+1}function Nc(b){return b._applyShimCurrentVersion===b._applyShimNextVersion}function Me(b){b._applyShimValidatingVersion=b._applyShimNextVersion;b._validating||(b._validating=!0,Ne.then(function(){b._applyShimCurrentVersion=b._applyShimNextVersion;b._validating=!1}))}function Oc(){ua=document.documentElement.getAttribute("dir");ua=document.documentElement.getAttribute("dir");
for(let a=0;a<va.length;a++){var b=va[a];b.__autoDirOptOut||b.setAttribute("dir",ua)}}function Pc(){document.body.removeAttribute("unresolved")}function wa(b,a,c){return{index:b,removed:a,addedCount:c}}function Qc(b,a,c,d,e,f){var g=0,h=0,k=Math.min(c-a,f-e);if(0==a&&0==e)a:{for(g=0;g<k;g++)if(b[g]!==d[g])break a;g=k}if(c==b.length&&f==d.length){h=k-g;k=b.length;for(var l=d.length,m=0;m<h&&Oe(b[--k],d[--l]);)m++;h=m}a+=g;e+=g;c-=h;f-=h;if(0==c-a&&0==f-e)return[];if(a==c){for(c=wa(a,[],0);e<f;)c.removed.push(d[e++]);
return[c]}if(e==f)return[wa(a,[],c-a)];g=a;h=e;f=f-h+1;k=c-g+1;c=Array(f);for(l=0;l<f;l++)c[l]=Array(k),c[l][0]=l;for(l=0;l<k;l++)c[0][l]=l;for(l=1;l<f;l++)for(m=1;m<k;m++)if(b[g+m-1]===d[h+l-1])c[l][m]=c[l-1][m-1];else{var n=c[l-1][m]+1;let p=c[l][m-1]+1;c[l][m]=n<p?n:p}f=c.length-1;g=c[0].length-1;h=c[f][g];for(b=[];0<f||0<g;)0==f?(b.push(2),g--):0==g?(b.push(3),f--):(k=c[f-1][g-1],l=c[f-1][g],m=c[f][g-1],n=l<m?l<k?l:k:m<k?m:k,n==k?(k==h?b.push(0):(b.push(1),h=k),f--,g--):n==l?(b.push(3),f--,h=
l):(b.push(2),g--,h=m));b.reverse();c=void 0;f=[];for(g=0;g<b.length;g++)switch(b[g]){case 0:c&&(f.push(c),c=void 0);a++;e++;break;case 1:c||(c=wa(a,[],0));c.addedCount++;a++;c.removed.push(d[e]);e++;break;case 2:c||(c=wa(a,[],0));c.addedCount++;a++;break;case 3:c||(c=wa(a,[],0)),c.removed.push(d[e]),e++}c&&f.push(c);return f}function Oe(b,a){return b===a}function ca(b){return"slot"===b.localName}function Pe(b,a){for(let c=0;c<a.length;c++){let d=a[c];b[d]=function(){return this.node[d].apply(this.node,
arguments)}}}function Rc(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},configurable:!0})}}function Qe(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},set:function(e){this.node[d]=e},configurable:!0})}}function Re(b,a=!1){if(!Hb||!Sc||!Hb.handlesDynamicScoping)return null;const c=Sc.ScopingShim;if(!c)return null;const d=c.scopeForNode(b),e=q(b).getRootNode(),f=g=>{if(q(g).getRootNode()===
...
f=Object.getOwnPropertyNames(a);for(let g=0;g<f.length;g++){let h=f[g];if(!(h in d))if(e)b[h]=a[h];else{let k=Object.getOwnPropertyDescriptor(a,h);k&&(k.configurable=!0,Object.defineProperty(b,h,k))}}for(let g in Se)a[g]&&(c[g]=c[g]||[],c[g].push(a[g]))}function Uc(b,a,c){a=a||[];for(let d=b.length-1;0<=d;d--){let e=b[d];e?Array.isArray(e)?Uc(e,a):0>a.indexOf(e)&&(!c||0>c.indexOf(e))&&a.unshift(e):console.warn("behavior is null, check for missing or 404 import")}return a}function Vc(b,a){for(const c in a){const d=
b[c],e=a[c];b[c]=!("value"in e)&&d&&"value"in d?Object.assign({value:d.value},e):e}}function Te(b,a,c){let d;const e={};class f extends a{static _finalizeClass(){if(this.hasOwnProperty("generatedFrom")){if(d)for(let h=0,k;h<d.length;h++)k=d[h],k.properties&&this.createProperties(k.properties),k.observers&&this.createObservers(k.observers,k.properties);b.properties&&this.createProperties(b.properties);b.observers&&this.createObservers(b.observers,b.properties);this._prepareTemplate()}else a._finalizeClass.call(this)}static get properties(){const h=
...
for(let l=0;l<k.length;l++)Tc(h,k[l],e,Ue)}Tc(h,b,e,Wc)};xa||g(f.prototype);f.generatedFrom=b;return f}function Ib(b,a,c,d,e){let f;e&&(f="object"===typeof c&&null!==c)&&(d=b.__dataTemp[a]);d=d!==c&&(d===d||c===c);f&&d&&(b.__dataTemp[a]=c);return d}function Jb(){return Kb}function Xc(b,a){for(let c=0;c<a.length;c++){let d=a[c];if(!!b!=!!d.__hideTemplateChildren__)if(d.nodeType===Node.TEXT_NODE)b?(d.__polymerTextContent__=d.textContent,d.textContent=""):d.textContent=d.__polymerTextContent__;else if("slot"===
d.localName)if(b)d.__polymerReplaced__=document.createComment("hidden-slot"),q(q(d).parentNode).replaceChild(d.__polymerReplaced__,d);else{const e=d.__polymerReplaced__;e&&q(q(e).parentNode).replaceChild(d,e)}else d.style&&(b?(d.__polymerDisplay__=d.style.display,d.style.display="none"):d.style.display=d.__polymerDisplay__);d.__hideTemplateChildren__=b;d._showHideChildren&&d._showHideChildren(b)}}function Yc(b){return(b=b.__dataHost)&&b._methodHost||b}function Ve(b,a){return function(c,d,e){a.call(c.__templatizeOwner,
d.substring(6),e[d])}}function We(b,a){return function(c,d,e){a.call(c.__templatizeOwner,c,d,e[d])}}function Xe(){return function(b,a,c){b.__dataHost._setPendingPropertyOrPath("_host_"+a,c[a],!0,!0)}}function ya(b,a,c){if(da&&!Yc(b))throw Error("strictTemplatePolicy: template owner not trusted");c=c||{};if(b.__templatizeOwner)throw Error("A \x3ctemplate\x3e can only be templatized once");b.__templatizeOwner=a;let d=(a?a.constructor:R)._parseTemplate(b);var e=d.templatizeInstanceClass;if(!e){e=c;var f=
e.mutableData?Ye:R;ya.mixin&&(f=ya.mixin(f));var g=class extends f{};g.prototype.__templatizeOptions=e;g.prototype._bindTemplate(b);f=g;var h=d.hostProps||{};for(var k in e.instanceProps){delete h[k];var l=e.notifyInstanceProp;l&&f.prototype._addPropertyEffect(k,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:We(k,l)})}if(e.forwardHostProp&&b.__dataHost)for(var m in h)d.hasHostProps||(d.hasHostProps=!0),f.prototype._addPropertyEffect(m,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:Xe()});e=g;d.templatizeInstanceClass=
e}k=Yc(b);f=c;if((g=f.forwardHostProp)&&d.hasHostProps){c="template"==b.localName;m=d.templatizeTemplateClass;if(!m){if(c){m=f.mutableData?Ze:Zc;class v extends m{}m=d.templatizeTemplateClass=v}else{m=b.constructor;class v extends m{}m=d.templatizeTemplateClass=v}h=d.hostProps;for(var n in h)m.prototype._addPropertyEffect("_host_"+n,m.prototype.PROPERTY_EFFECT_TYPES.PROPAGATE,{fn:Ve(n,g)}),m.prototype._createNotifyingProperty("_host_"+n);if($c&&k){n=k.constructor._properties;({propertyEffects:g}=
...
m.prototype),p=d.hostProps,p)r="_host_"+r,r in b&&(p=b[r],delete b[r],b.__data[r]=p)}r=class extends e{};r.prototype._methodHost=k;r.prototype.__dataHost=b;r.prototype.__templatizeOwner=a;r.prototype.__hostProps=d.hostProps;return r}function Lb(){if(xa&&!Mb){if(!ad){ad=!0;const b=document.createElement("style");b.textContent="dom-bind,dom-if,dom-repeat{display:none;}";document.head.appendChild(b)}return!0}return!1}class $e extends HTMLElement{static get version(){return"1.6.1"}}customElements.define("vaadin-lumo-styles",
$e);let jb=null,cc=window.HTMLImports&&window.HTMLImports.whenReady||null,kb,Va=null,za=null;class S{constructor(){this.customStyles=[];this.enqueued=!1;bc(()=>{window.ShadyCSS.flushCustomStyles&&window.ShadyCSS.flushCustomStyles()})}enqueueDocumentValidation(){!this.enqueued&&za&&(this.enqueued=!0,bc(za))}addCustomStyle(b){b.__seenByShadyCSS||(b.__seenByShadyCSS=!0,this.customStyles.push(b),this.enqueueDocumentValidation())}getStyleForCustomStyle(b){return b.__shadyCSSCachedStyle?b.__shadyCSSCachedStyle:
b.getStyle?b.getStyle():b}processStyles(){const b=this.customStyles;for(let c=0;c<b.length;c++){const d=b[c];if(!d.__shadyCSSCachedStyle){var a=this.getStyleForCustomStyle(d);a&&(a=a.__appliedElement||a,Va&&Va(a),d.__shadyCSSCachedStyle=a)}}return b}}S.prototype.addCustomStyle=S.prototype.addCustomStyle;S.prototype.getStyleForCustomStyle=S.prototype.getStyleForCustomStyle;S.prototype.processStyles=S.prototype.processStyles;Object.defineProperties(S.prototype,{transformCallback:{get(){return Va},set(b){Va=
b}},validateCallback:{get(){return za},set(b){let a=!1;za||(a=!0);za=b;a&&this.enqueueDocumentValidation()}}});const Nb=/(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,Wa=/(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,Ke=/@media\s(.*)/,La=!(window.ShadyDOM&&window.ShadyDOM.inUse);let mb,ta;window.ShadyCSS&&void 0!==window.ShadyCSS.cssBuild&&(ta=window.ShadyCSS.cssBuild);const bd=!(!window.ShadyCSS||!window.ShadyCSS.disableRuntime);
window.ShadyCSS&&void 0!==window.ShadyCSS.nativeCss?mb=window.ShadyCSS.nativeCss:window.ShadyCSS?(ec(window.ShadyCSS),window.ShadyCSS=void 0):ec(window.WebComponents&&window.WebComponents.flags);const Fb=mb,Xa=new S;window.ShadyCSS||(window.ShadyCSS={prepareTemplate(b,a,c){},prepareTemplateDom(b,a){},prepareTemplateStyles(b,a,c){},styleSubtree(b,a){Xa.processStyles();lb(b,a)},styleElement(b){Xa.processStyles()},styleDocument(b){Xa.processStyles();lb(document.body,b)},getComputedStyleValue(b,a){return dc(b,
a)},flushCustomStyles(){},nativeCss:Fb,nativeShadow:La,cssBuild:ta,disableRuntime:bd});window.ShadyCSS.CustomStyleInterface=Xa;window.JSCompiler_renameProperty=function(b,a){return b};let ie=/(url\()([^)]*)(\))/g,he=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/,Ma,E;const Mb=!window.ShadyDOM||!window.ShadyDOM.inUse;!(window.ShadyCSS&&!window.ShadyCSS.nativeCss);const af=Mb&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const b=new CSSStyleSheet;b.replaceSync("");const a=
document.createElement("div");a.attachShadow({mode:"open"});a.shadowRoot.adoptedStyleSheets=[b];return a.shadowRoot.adoptedStyleSheets[0]===b}catch(b){return!1}})();let bf=window.Polymer&&window.Polymer.rootPath||ob(document.baseURI||window.location.href),Pa=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0,xe=window.Polymer&&window.Polymer.setPassiveTouchGestures||!1,da=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,cf=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,
xa=window.Polymer&&window.Polymer.legacyOptimizations||!1,$c=window.Polymer&&window.Polymer.legacyWarnings||!1,df=window.Polymer&&window.Polymer.syncInitialRender||!1,wb=window.Polymer&&window.Polymer.legacyUndefined||!1,ef=window.Polymer&&window.Polymer.orderedComputed||!1,cd=window.Polymer&&window.Polymer.removeNestedTemplates||!1,dd=window.Polymer&&window.Polymer.fastDomIf||!1,Ob=window.Polymer&&window.Polymer.suppressTemplateNotifications||!1,Ya=window.Polymer&&window.Polymer.legacyNoObservedAttributes||
!1,ff=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1,Aa={},Za={};class O extends HTMLElement{static get observedAttributes(){return["id"]}static import(b,a){return b?(b=Aa[b]||Za[b.toLowerCase()])&&a?b.querySelector(a):b:null}attributeChangedCallback(b,a,c,d){a!==c&&this.register()}get assetpath(){if(!this.__assetpath){var b=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument;b=ka(this.getAttribute("assetpath")||"",
b.baseURI);this.__assetpath=ob(b)}return this.__assetpath}register(b){if(b=b||this.id){if(da&&void 0!==(Aa[b]||Za[b.toLowerCase()]))throw Aa[b]=Za[b.toLowerCase()]=null,Error(`strictTemplatePolicy: dom-module ${b} re-registered`);this.id=b;Aa[b]=Za[b.toLowerCase()]=this;this.querySelector("style")&&console.warn("dom-module %s has style outside template",this.id)}}}O.prototype.modules=Aa;customElements.define("dom-module",O);const gf=window.ShadyCSS.CustomStyleInterface;class hf extends HTMLElement{constructor(){super();
this._style=null;gf.addCustomStyle(this)}getStyle(){if(this._style)return this._style;const b=this.querySelector("style");if(!b)return null;this._style=b;var a=b.getAttribute("include");if(a){b.removeAttribute("include");a=a.trim().split(/\s+/);var c="";for(let h=0;h<a.length;h++){var d=void 0,e=void 0,f=a[h];let k=O.import(f);if(k&&void 0===k._cssText){e="";d=pb(k);for(var g=0;g<d.length;g++)e+=d[g].textContent;if(g=k.querySelector("template")){d="";g=qb(g,k.assetpath);for(let l=0;l<g.length;l++){let m=
g[l];m.parentNode&&m.parentNode.removeChild(m);d+=m.textContent}e+=d}k._cssText=e||null}k||console.warn("Could not find style data in module named",f);c+=k&&k._cssText||""}b.textContent=c+b.textContent}this.ownerDocument!==window.document&&window.document.head.appendChild(this);return this._style}}window.customElements.define("custom-style",hf);const ed=document.createElement("template");ed.innerHTML='\x3ccustom-style\x3e\n  \x3cstyle\x3e\n    html {\n      /* Base (background) */\n      --lumo-base-color: #FFF;\n\n      /* Tint */\n      --lumo-tint-5pct: hsla(0, 0%, 100%, 0.3);\n      --lumo-tint-10pct: hsla(0, 0%, 100%, 0.37);\n      --lumo-tint-20pct: hsla(0, 0%, 100%, 0.44);\n      --lumo-tint-30pct: hsla(0, 0%, 100%, 0.5);\n      --lumo-tint-40pct: hsla(0, 0%, 100%, 0.57);\n      --lumo-tint-50pct: hsla(0, 0%, 100%, 0.64);\n      --lumo-tint-60pct: hsla(0, 0%, 100%, 0.7);\n      --lumo-tint-70pct: hsla(0, 0%, 100%, 0.77);\n      --lumo-tint-80pct: hsla(0, 0%, 100%, 0.84);\n      --lumo-tint-90pct: hsla(0, 0%, 100%, 0.9);\n      --lumo-tint: #FFF;\n\n      /* Shade */\n      --lumo-shade-5pct: hsla(214, 61%, 25%, 0.05);\n      --lumo-shade-10pct: hsla(214, 57%, 24%, 0.1);\n      --lumo-shade-20pct: hsla(214, 53%, 23%, 0.16);\n      --lumo-shade-30pct: hsla(214, 50%, 22%, 0.26);\n      --lumo-shade-40pct: hsla(214, 47%, 21%, 0.38);\n      --lumo-shade-50pct: hsla(214, 45%, 20%, 0.5);\n      --lumo-shade-60pct: hsla(214, 43%, 19%, 0.61);\n      --lumo-shade-70pct: hsla(214, 42%, 18%, 0.72);\n      --lumo-shade-80pct: hsla(214, 41%, 17%, 0.83);\n      --lumo-shade-90pct: hsla(214, 40%, 16%, 0.94);\n      --lumo-shade: hsl(214, 35%, 15%);\n\n      /* Contrast */\n      --lumo-contrast-5pct: var(--lumo-shade-5pct);\n      --lumo-contrast-10pct: var(--lumo-shade-10pct);\n      --lumo-contrast-20pct: var(--lumo-shade-20pct);\n      --lumo-contrast-30pct: var(--lumo-shade-30pct);\n      --lumo-contrast-40pct: var(--lumo-shade-40pct);\n      --lumo-contrast-50pct: var(--lumo-shade-50pct);\n      --lumo-contrast-60pct: var(--lumo-shade-60pct);\n      --lumo-contrast-70pct: var(--lumo-shade-70pct);\n      --lumo-contrast-80pct: var(--lumo-shade-80pct);\n      --lumo-contrast-90pct: var(--lumo-shade-90pct);\n      --lumo-contrast: var(--lumo-shade);\n\n      /* Text */\n      --lumo-header-text-color: var(--lumo-contrast);\n      --lumo-body-text-color: var(--lumo-contrast-90pct);\n      --lumo-secondary-text-color: var(--lumo-contrast-70pct);\n      --lumo-tertiary-text-color: var(--lumo-contrast-50pct);\n      --lumo-disabled-text-color: var(--lumo-contrast-30pct);\n\n      /* Primary */\n      --lumo-primary-color: hsl(214, 90%, 52%);\n      --lumo-primary-color-50pct: hsla(214, 90%, 52%, 0.5);\n      --lumo-primary-color-10pct: hsla(214, 90%, 52%, 0.1);\n      --lumo-primary-text-color: var(--lumo-primary-color);\n      --lumo-primary-contrast-color: #FFF;\n\n      /* Error */\n      --lumo-error-color: hsl(3, 100%, 61%);\n      --lumo-error-color-50pct: hsla(3, 100%, 60%, 0.5);\n      --lumo-error-color-10pct: hsla(3, 100%, 60%, 0.1);\n      --lumo-error-text-color: hsl(3, 92%, 53%);\n      --lumo-error-contrast-color: #FFF;\n\n      /* Success */\n      --lumo-success-color: hsl(145, 80%, 42%); /* hsl(144,82%,37%); */\n      --lumo-success-color-50pct: hsla(145, 76%, 44%, 0.55);\n      --lumo-success-color-10pct: hsla(145, 76%, 44%, 0.12);\n      --lumo-success-text-color: hsl(145, 100%, 32%);\n      --lumo-success-contrast-color: #FFF;\n    }\n  \x3c/style\x3e\n\x3c/custom-style\x3e\x3cdom-module id\x3d"lumo-color"\x3e\n  \x3ctemplate\x3e\n    \x3cstyle\x3e\n      [theme~\x3d"dark"] {\n        /* Base (background) */\n        --lumo-base-color: hsl(214, 35%, 21%);\n\n        /* Tint */\n        --lumo-tint-5pct: hsla(214, 65%, 85%, 0.06);\n        --lumo-tint-10pct: hsla(214, 60%, 80%, 0.14);\n        --lumo-tint-20pct: hsla(214, 64%, 82%, 0.23);\n        --lumo-tint-30pct: hsla(214, 69%, 84%, 0.32);\n        --lumo-tint-40pct: hsla(214, 73%, 86%, 0.41);\n        --lumo-tint-50pct: hsla(214, 78%, 88%, 0.5);\n        --lumo-tint-60pct: hsla(214, 82%, 90%, 0.6);\n        --lumo-tint-70pct: hsla(214, 87%, 92%, 0.7);\n        --lumo-tint-80pct: hsla(214, 91%, 94%, 0.8);\n        --lumo-tint-90pct: hsla(214, 96%, 96%, 0.9);\n        --lumo-tint: hsl(214, 100%, 98%);\n\n        /* Shade */\n        --lumo-shade-5pct: hsla(214, 0%, 0%, 0.07);\n        --lumo-shade-10pct: hsla(214, 4%, 2%, 0.15);\n        --lumo-shade-20pct: hsla(214, 8%, 4%, 0.23);\n        --lumo-shade-30pct: hsla(214, 12%, 6%, 0.32);\n        --lumo-shade-40pct: hsla(214, 16%, 8%, 0.41);\n        --lumo-shade-50pct: hsla(214, 20%, 10%, 0.5);\n        --lumo-shade-60pct: hsla(214, 24%, 12%, 0.6);\n        --lumo-shade-70pct: hsla(214, 28%, 13%, 0.7);\n        --lumo-shade-80pct: hsla(214, 32%, 13%, 0.8);\n        --lumo-shade-90pct: hsla(214, 33%, 13%, 0.9);\n        --lumo-shade: hsl(214, 33%, 13%);\n\n        /* Contrast */\n        --lumo-contrast-5pct: var(--lumo-tint-5pct);\n        --lumo-contrast-10pct: var(--lumo-tint-10pct);\n        --lumo-contrast-20pct: var(--lumo-tint-20pct);\n        --lumo-contrast-30pct: var(--lumo-tint-30pct);\n        --lumo-contrast-40pct: var(--lumo-tint-40pct);\n        --lumo-contrast-50pct: var(--lumo-tint-50pct);\n        --lumo-contrast-60pct: var(--lumo-tint-60pct);\n        --lumo-contrast-70pct: var(--lumo-tint-70pct);\n        --lumo-contrast-80pct: var(--lumo-tint-80pct);\n        --lumo-contrast-90pct: var(--lumo-tint-90pct);\n        --lumo-contrast: var(--lumo-tint);\n\n        /* Text */\n        --lumo-header-text-color: var(--lumo-contrast);\n        --lumo-body-text-color: var(--lumo-contrast-90pct);\n        --lumo-secondary-text-color: var(--lumo-contrast-70pct);\n        --lumo-tertiary-text-color: var(--lumo-contrast-50pct);\n        --lumo-disabled-text-color: var(--lumo-contrast-30pct);\n\n        /* Primary */\n        --lumo-primary-color: hsl(214, 86%, 55%);\n        --lumo-primary-color-50pct: hsla(214, 86%, 55%, 0.5);\n        --lumo-primary-color-10pct: hsla(214, 90%, 63%, 0.1);\n        --lumo-primary-text-color: hsl(214, 100%, 70%);\n        --lumo-primary-contrast-color: #FFF;\n\n        /* Error */\n        --lumo-error-color: hsl(3, 90%, 63%);\n        --lumo-error-color-50pct: hsla(3, 90%, 63%, 0.5);\n        --lumo-error-color-10pct: hsla(3, 90%, 63%, 0.1);\n        --lumo-error-text-color: hsl(3, 100%, 67%);\n\n        /* Success */\n        --lumo-success-color: hsl(145, 65%, 42%);\n        --lumo-success-color-50pct: hsla(145, 65%, 42%, 0.5);\n        --lumo-success-color-10pct: hsla(145, 65%, 42%, 0.1);\n        --lumo-success-text-color: hsl(145, 85%, 47%);\n      }\n\n      html {\n        color: var(--lumo-body-text-color);\n        background-color: var(--lumo-base-color);\n      }\n\n      [theme~\x3d"dark"] {\n        color: var(--lumo-body-text-color);\n        background-color: var(--lumo-base-color);\n      }\n\n      h1,\n      h2,\n      h3,\n      h4,\n      h5,\n      h6 {\n        color: var(--lumo-header-text-color);\n      }\n\n      a {\n        color: var(--lumo-primary-text-color);\n      }\n\n      blockquote {\n        color: var(--lumo-secondary-text-color);\n      }\n\n      code,\n      pre {\n        background-color: var(--lumo-contrast-10pct);\n        border-radius: var(--lumo-border-radius-m);\n      }\n    \x3c/style\x3e\n  \x3c/template\x3e\n\x3c/dom-module\x3e\x3cdom-module id\x3d"lumo-color-legacy"\x3e\n  \x3ctemplate\x3e\n    \x3cstyle include\x3d"lumo-color"\x3e\n      :host {\n        color: var(--lumo-body-text-color) !important;\n        background-color: var(--lumo-base-color) !important;\n      }\n    \x3c/style\x3e\n  \x3c/template\x3e\n\x3c/dom-module\x3e';
...
document.head.appendChild(jd.content);String(Math.random()).slice(2);new WeakMap;window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:b=>b});(()=>{try{const b={get capture(){return!1}};window.addEventListener("test",b,b);window.removeEventListener("test",b,b)}catch(b){}})();new Map;new WeakMap;"undefined"!==typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");"undefined"!==typeof window.ShadyCSS&&"undefined"===typeof window.ShadyCSS.prepareTemplateDom&&
console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1.");new Set;window.JSCompiler_renameProperty=(b,a)=>b;const jf=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,kd=Symbol();class Pb{constructor(b,a){if(a!==kd)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=
b}get styleSheet(){void 0===this._styleSheet&&(jf?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null);return this._styleSheet}toString(){return this.cssText}}const Ba=(b,...a)=>{a=a.reduce((c,d,e)=>{if(d instanceof Pb)d=d.cssText;else if("number"!==typeof d)throw Error(`Value passed to 'css' function must be a 'css' function result: ${d}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`);return c+d+
b[e+1]},b[0]);return new Pb(a,kd)};(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");let ld=0;const Qb={},Ca=(b,a,c)=>{const d=c&&c.moduleId||`custom-style-module-${ld++}`;Array.isArray(a)||(a=a?[a]:[]);a.forEach(f=>{if(!(f instanceof Pb))throw Error("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`.");if(!Qb[f]){const g=document.createElement("dom-module");g.innerHTML=`\n        <template>\n          <style>${f.toString()}</style>\n        </template>\n      `;
const h=`custom-style-module-${ld++}`;g.register(h);Qb[f]=h}});const e=document.createElement("dom-module");if(b){const f=window.customElements&&window.customElements.get(b);f&&f.hasOwnProperty("__finalized")&&console.warn(`The custom element definition for "${b}"\n      was finalized before a style module was registered.\n      Make sure to add component specific style modules before\n      importing the corresponding custom element.`);e.setAttribute("theme-for",b)}e.innerHTML=`\n    <template>\n      ${(c&&
c.include||[]).map(f=>`<style include=${f}></style>`)}\n      ${a.map(f=>`<style include=${Qb[f]}></style>`)}\n    </template>\n  `;e.register(d)};Ca("vaadin-checkbox",Ba`
  ...
  `,{moduleId:"lumo-checkbox"});let kf=0;const F=function(b){let a=b.__mixinApplications;a||(a=new WeakMap,b.__mixinApplications=a);let c=kf++;return function(d){let e=d.__mixinSet;if(e&&e[c])return d;let f=a,g=f.get(d);g||(g=b(d),f.set(d,g),d=Object.create(g.__mixinSet||e||null),d[c]=!0,g.__mixinSet=d);return g}},q=window.ShadyDOM&&window.ShadyDOM.noPatch&&window.ShadyDOM.wrap?window.ShadyDOM.wrap:window.ShadyDOM?b=>ShadyDOM.patch(b):b=>b,Na={},le=/-[a-z]/g,me=/([A-Z])/g;let lf=0,md=0,ea=[],mf=0,
Rb=!1,nd=document.createTextNode("");(new window.MutationObserver(function(){Rb=!1;const b=ea.length;for(let a=0;a<b;a++){let c=ea[a];if(c)try{c()}catch(d){setTimeout(()=>{throw d;})}}ea.splice(0,b);md+=b})).observe(nd,{characterData:!0});const I={after(b){return{run(a){return window.setTimeout(a,b)},cancel(a){window.clearTimeout(a)}}},run(b,a){return window.setTimeout(b,a)},cancel(b){window.clearTimeout(b)}},L={run(b){return window.requestAnimationFrame(b)},cancel(b){window.cancelAnimationFrame(b)}},
od={run(b){return window.requestIdleCallback?window.requestIdleCallback(b):window.setTimeout(b,16)},cancel(b){window.cancelIdleCallback?window.cancelIdleCallback(b):window.clearTimeout(b)}},G={run(b){Rb||(Rb=!0,nd.textContent=mf++);ea.push(b);return lf++},cancel(b){const a=b-md;if(0<=a){if(!ea[a])throw Error("invalid async handle: "+b);ea[a]=null}}},nf=G,pd=F(b=>{class a extends b{static createProperties(c){const d=this.prototype;for(let e in c)e in d||d._createPropertyAccessor(e)}static attributeNameForProperty(c){return c.toLowerCase()}static typeForProperty(c){}_createPropertyAccessor(c,
...
"":void 0;default:return null!=c?c.toString():void 0}}_deserializeValue(c,d){switch(d){case Boolean:return null!==c;case Number:return Number(c);default:return c}}}return a}),qd={};let $a=HTMLElement.prototype;for(;$a;){let b=Object.getOwnPropertyNames($a);for(let a=0;a<b.length;a++)qd[b[a]]=!0;$a=Object.getPrototypeOf($a)}const rd=F(b=>{b=pd(b);class a extends b{static createPropertiesForAttributes(){let c=this.observedAttributes;for(let d=0;d<c.length;d++)this.prototype._createPropertyAccessor(ic(c[d]))}static attributeNameForProperty(c){return Oa(c)}_initializeProperties(){this.__dataProto&&
...
d)}_hasAccessor(c){return this.__dataHasAccessor&&this.__dataHasAccessor[c]}_isPropertyPending(c){return!!(this.__dataPending&&c in this.__dataPending)}}return a}),of={"dom-if":!0,"dom-repeat":!0};let sd=!1,td=!1;const pf=F(b=>{class a extends b{static _parseTemplate(c,d){if(!c._templateInfo){let e=c._templateInfo={};e.nodeInfoList=[];e.nestedTemplate=!!d;e.stripWhiteSpace=d&&d.stripWhiteSpace||c.hasAttribute("strip-whitespace");this._parseTemplateContent(c,e,{parent:null})}return c._templateInfo}static _parseTemplateContent(c,
...
qf=/[A-Z]/,ud=(b,a,c,d,e)=>{var f=e?J(b):b;if(a=a[f])for(f=0;f<a.length;f++){var g=a[f];if(g.info.lastRun!==na&&(!e||sb(b,g.trigger))){g.info.lastRun=na;g=g.info;var h=c,k=d;let l=0,m=h.length-1,n=-1;for(;l<=m;){const p=l+m>>1,r=k.get(h[p].methodInfo)-k.get(g.methodInfo);if(0>r)l=p+1;else if(0<r)m=p-1;else{n=p;break}}0>n&&(n=m+1);h.splice(n,0,g)}}},ue=[],vd=RegExp("(\\[\\[|{{)\\s*(?:(!)\\s*)?((?:[a-zA-Z_$][\\w.:$\\-*]*)\\s*(?:\\(\\s*(?:(?:(?:((?:[a-zA-Z_$][\\w.:$\\-*]*)|(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\\\]|\\\\.)*')|(?:\"(?:[^\"\\\\]|\\\\.)*\")))\\s*)(?:,\\s*(?:((?:[a-zA-Z_$][\\w.:$\\-*]*)|(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\\\]|\\\\.)*')|(?:\"(?:[^\"\\\\]|\\\\.)*\")))\\s*))*)?)\\)\\s*)?)(?:]]|}})",
"g"),ab=F(b=>{const a=pf(rd(b));class c extends a{constructor(){super();this.__isPropertyEffectsClient=!0;this.__dataClientsReady;this.__dataPendingClients;this.__dataToNotify;this.__dataLinkedPaths;this.__dataHasPaths;this.__dataCompoundStorage;this.__dataHost;this.__dataTemp;this.__dataClientsInitialized;this.__data;this.__dataPending;this.__dataOld;this.__computeEffects;this.__computeInfo;this.__reflectEffects;this.__notifyEffects;this.__propagateEffects;this.__observeEffects;this.__readOnly;this.__templateInfo;
...
e){for(let f in d)!e&&this[t.READ_ONLY]&&this[t.READ_ONLY][f]||this._setPendingPropertyOrPath(f,d[f],!0);this._invalidateProperties()}ready(){this._flushProperties();this.__dataClientsReady||this._flushClients();this.__dataPending&&this._flushProperties()}_propertiesChanged(d,e,f){d=this.__dataHasPaths;this.__dataHasPaths=!1;var g;if(g=this[t.COMPUTE])if(ef){na++;var h=qe(this),k=[];for(var l in e)ud(l,g,k,h,d);for(;l=k.shift();)mc(this,"",e,f,l)&&ud(l.methodInfo,g,k,h,d);Object.assign(f,this.__dataOld);
Object.assign(e,this.__dataPending);this.__dataPending=null}else for(h=e;ma(this,g,h,f,d);)Object.assign(f,this.__dataOld),Object.assign(e,this.__dataPending),h=this.__dataPending,this.__dataPending=null;g=this.__dataToNotify;this.__dataToNotify=null;this._propagatePropertyChanges(e,f,d);this._flushClients();ma(this,this[t.REFLECT],e,f,d);ma(this,this[t.OBSERVE],e,f,d);if(g){h=this[t.NOTIFY];let B;k=na++;for(let T in g)if(g[T]){if(l=h){var m=h;l=k;var n=T,p=e,r=f,v=d;let wd=!1,rf=v?J(n):n;if(m=m[rf])for(let Sb=
0,sf=m.length,U;Sb<sf&&(U=m[Sb]);Sb++)U.info&&U.info.lastRun===l||v&&!sb(n,U.trigger)||(U.info&&(U.info.lastRun=l),U.fn(this,n,p,r,U.info,v,void 0),wd=!0);l=wd}if(l)B=!0;else{if(l=d)l=T,n=e,p=J(l),p!==l?(p=Oa(p)+"-changed",lc(this,p,n[l],l),l=!0):l=!1;l&&(B=!0)}}let H;B&&(H=this.__dataHost)&&H._invalidateProperties&&H._invalidateProperties()}1==this.__dataCounter&&(this.__dataTemp={})}_propagatePropertyChanges(d,e,f){this[t.PROPAGATE]&&ma(this,this[t.PROPAGATE],d,e,f);this.__templateInfo&&this._runEffectsForTemplate(this.__templateInfo,
d,e,f)}_runEffectsForTemplate(d,e,f,g){const h=(k,l)=>{ma(this,d.propertyEffects,k,f,l,d.nodeList);for(let m=d.firstChild;m;m=m.nextSibling)this._runEffectsForTemplate(m,k,f,l)};d.runEffects?d.runEffects(h,e,g):h(e,g)}linkPaths(d,e){d=la(d);e=la(e);this.__dataLinkedPaths=this.__dataLinkedPaths||{};this.__dataLinkedPaths[d]=e}unlinkPaths(d){d=la(d);this.__dataLinkedPaths&&delete this.__dataLinkedPaths[d]}notifySplices(d,e){let f={path:""};d=C(this,d,f);rc(this,d,f.path,e)}get(d,e){return C(e||this,
d)}set(d,e,f){f?hc(f,d,e):this[t.READ_ONLY]&&this[t.READ_ONLY][d]||this._setPendingPropertyOrPath(d,e,!0)&&this._invalidateProperties()}push(d,...e){let f={path:""};d=C(this,d,f);let g=d.length,h=d.push(...e);e.length&&pa(this,d,f.path,g,e.length,[]);return h}pop(d){let e={path:""};d=C(this,d,e);let f=!!d.length,g=d.pop();f&&pa(this,d,e.path,d.length,0,[g]);return g}splice(d,e,f,...g){let h={path:""},k=C(this,d,h);0>e?e=k.length-Math.floor(-e):e&&(e=Math.floor(e));let l;l=2===arguments.length?k.splice(e):
k.splice(e,f,...g);(g.length||l.length)&&pa(this,k,h.path,e,g.length,l);return l}shift(d){let e={path:""};d=C(this,d,e);let f=!!d.length,g=d.shift();f&&pa(this,d,e.path,0,0,[g]);return g}unshift(d,...e){let f={path:""};d=C(this,d,f);let g=d.unshift(...e);e.length&&pa(this,d,f.path,0,e.length,[]);return g}notifyPath(d,e){if(1==arguments.length){var f={path:""};e=C(this,d,f);f=f.path}else f=Array.isArray(d)?la(d):d;this._setPendingPropertyOrPath(f,e,!0,!0)&&this._invalidateProperties()}_createReadOnlyProperty(d,
e){this._addPropertyEffect(d,t.READ_ONLY);e&&(this["_set"+we(d)]=function(f){this._setProperty(d,f)})}_createPropertyObserver(d,e,f){let g={property:d,method:e,dynamicFn:!!f};this._addPropertyEffect(d,t.OBSERVE,{fn:kc,info:g,trigger:{name:d}});f&&this._addPropertyEffect(e,t.OBSERVE,{fn:kc,info:g,trigger:{name:e}})}_createMethodObserver(d,e){let f=vb(d);if(!f)throw Error("Malformed observer expression '"+d+"'");oc(this,f,t.OBSERVE,tb,null,e)}_createNotifyingProperty(d){this._addPropertyEffect(d,t.NOTIFY,
{fn:oe,info:{eventName:Oa(d)+"-changed",property:d}})}_createReflectedProperty(d){let e=this.constructor.attributeNameForProperty(d);"-"===e[0]?console.warn("Property "+d+" cannot be reflected to attribute "+e+' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.'):this._addPropertyEffect(d,t.REFLECT,{fn:pe,info:{attrName:e}})}_createComputedProperty(d,e,f){let g=vb(e);if(!g)throw Error("Malformed computed expression '"+e+"'");e=oc(this,g,t.COMPUTE,
mc,d,f);rb(this,"__computeInfo")[d]=e}_marshalArgs(d,e,f){const g=this.__data,h=[];for(let k=0,l=d.length;k<l;k++){let {name:m,structured:n,wildcard:p,value:r,literal:v}=d[k];if(!v)if(p){const B=0===e.indexOf(m+"."),H=qc(g,f,B?e:m);r={path:B?e:m,value:H,base:B?C(g,m):H}}else r=n?qc(g,f,m):g[m];if(wb&&!this._overrideLegacyUndefined&&void 0===r&&1<d.length)return oa;h[k]=r}return h}static addPropertyEffect(d,e,f){this.prototype._addPropertyEffect(d,e,f)}static createPropertyObserver(d,e,f){this.prototype._createPropertyObserver(d,
...
e){e=e||this._bindTemplate(d,!0);Da.push(this);d=super._stampTemplate(d,e);Da.pop();e.nodeList=d.nodeList;if(!e.wasPreBound){var f=e.childNodes=[];for(var g=d.firstChild;g;g=g.nextSibling)f.push(g)}d.templateInfo=e;let {nodeList:h,nodeInfoList:k}=e;if(k.length)for(let m=0;m<k.length;m++){let n=h[m],p=k[m].bindings;if(p)for(let r=0;r<p.length;r++){let v=p[r];f=n;g=v;if(g.isCompound){let B=f.__dataCompoundStorage||(f.__dataCompoundStorage={});var l=g.parts;let H=Array(l.length);for(let T=0;T<l.length;T++)H[T]=
l[T].literal;l=g.target;B[l]=H;g.literal&&"property"==g.kind&&("className"===l&&(f=q(f)),f[l]=g.literal)}te(n,this,v)}n.__dataHost=this}this.__dataClientsReady&&(this._runEffectsForTemplate(e,this.__data,null,!1),this._flushClients());return d}_removeBoundDom(d){d=d.templateInfo;const {previousSibling:e,nextSibling:f,parent:g}=d;e?e.nextSibling=f:g&&(g.firstChild=f);f?f.previousSibling=e:g&&(g.lastChild=e);d.nextSibling=d.previousSibling=null;d=d.childNodes;for(let h=0;h<d.length;h++){let k=d[h];
q(q(k).parentNode).removeChild(k)}}static _parseTemplateNode(d,e,f){let g=a._parseTemplateNode.call(this,d,e,f);if(d.nodeType===Node.TEXT_NODE){let h=this._parseBindings(d.textContent,e);h&&(d.textContent=pc(h)||" ",ub(this,e,f,"text","textContent",h),g=!0)}return g}static _parseTemplateNodeAttribute(d,e,f,g,h){let k=this._parseBindings(h,e);if(k){h=g;let l="property";qf.test(g)?l="attribute":"$"==g[g.length-1]&&(g=g.slice(0,-1),l="attribute");let m=pc(k);m&&"attribute"==l&&("class"==g&&d.hasAttribute("class")&&
(m+=" "+d.getAttribute(g)),d.setAttribute(g,m));"attribute"==l&&"disable-upgrade$"==h&&d.setAttribute(g,"");"input"===d.localName&&"value"===h&&d.setAttribute(h,"");d.removeAttribute(h);"property"===l&&(g=ic(g));ub(this,e,f,l,g,k,m);return!0}return a._parseTemplateNodeAttribute.call(this,d,e,f,g,h)}static _parseTemplateNestedTemplate(d,e,f){let g=a._parseTemplateNestedTemplate.call(this,d,e,f);const h=d.parentNode,k=f.templateInfo,l="dom-if"===h.localName,m="dom-repeat"===h.localName;cd&&(l||m)&&
(h.removeChild(d),f=f.parentInfo,f.templateInfo=k,f.noted=!0,g=!1);d=k.hostProps;if(dd&&l)d&&(e.hostProps=Object.assign(e.hostProps||{},d),cd||(f.parentInfo.noted=!0));else for(let n in d)ub(this,e,f,"property","_host_"+n,[{mode:"{",source:n,dependencies:[n],hostProp:!0}]);return g}static _parseBindings(d,e){let f=[];for(var g=0,h;null!==(h=vd.exec(d));){h.index>g&&f.push({literal:d.slice(g,h.index)});g=h[1][0];let m=!!h[2];h=h[3].trim();let n=!1,p="";var k=-1;"{"==g&&0<(k=h.indexOf("::"))&&(p=h.substring(k+
2),h=h.substring(0,k),n=!0);k=vb(h);let r=[];if(k){let {args:v,methodName:B}=k;for(var l=0;l<v.length;l++){let H=v[l];H.literal||r.push(H)}if((l=e.dynamicFns)&&l[B]||k.static)r.push(B),k.dynamicFn=!0}else r.push(h);f.push({source:h,mode:g,negate:m,customEvent:n,signature:k,dependencies:r,event:p});g=vd.lastIndex}g&&g<d.length&&(d=d.substring(g))&&f.push({literal:d});return f.length?f:null}static _evaluateBinding(d,e,f,g,h,k){d=e.signature?tb(d,f,g,h,e.signature):f!=e.source?C(d,e.source):k&&0<=f.indexOf(".")?
C(d,f):d.__data[f];e.negate&&(d=!d);return d}}return c}),Da=[],tf=F(b=>{function a(e){e=Object.getPrototypeOf(e);return e.prototype instanceof d?e:null}function c(e){if(!e.hasOwnProperty("__ownProperties")){var f=null;if(e.hasOwnProperty("properties")){var g=e.properties;if(g){f=g;g={};for(let h in f){const k=f[h];g[h]="function"===typeof k?{type:k}:k}f=g}}e.__ownProperties=f}return e.__ownProperties}b=pd(b);class d extends b{static get observedAttributes(){if(!this.hasOwnProperty("__observedAttributes")){const e=
...
this._properties[e])&&e.type}_initializeProperties(){this.constructor.finalize();super._initializeProperties()}connectedCallback(){super.connectedCallback&&super.connectedCallback();this._enableProperties()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback()}}return d}),Tb=window.ShadyCSS&&window.ShadyCSS.cssBuild,bb=F(b=>{function a(e,f,g,h){if(!Tb){const p=f.content.querySelectorAll("style"),r=qb(f);var k=ke(g),l=f.content.firstElementChild;for(var m=0;m<k.length;m++){var n=
k[m];n.textContent=e._processStyleText(n.textContent,h);f.content.insertBefore(n,l)}k=0;for(l=0;l<r.length;l++)m=r[l],n=p[k],n!==m?(m=m.cloneNode(!0),n.parentNode.insertBefore(m,n)):k++,m.textContent=e._processStyleText(m.textContent,h)}window.ShadyCSS&&window.ShadyCSS.prepareTemplate(f,g);if(ff&&Tb&&af&&(f=f.content.querySelectorAll("style"))){let p="";Array.from(f).forEach(r=>{p+=r.textContent;r.parentNode.removeChild(r)});e._styleSheet=new CSSStyleSheet;e._styleSheet.replaceSync(p)}}const c=tf(ab(b));
...
this.prototype.hasOwnProperty("_template")?this.prototype._template:void 0;if(void 0===e){if(e=this.hasOwnProperty("is")){e=this.is;let f=null;if(e&&(!da||cf)&&(f=O.import(e,"template"),da&&!f))throw Error(`strictTemplatePolicy: expecting dom-module or null template for ${e}`);e=f}e=e||Object.getPrototypeOf(this.prototype).constructor.template}this._template=e}return this._template}static set template(e){this._template=e}static get importPath(){if(!this.hasOwnProperty("_importPath")){var e=this.importMeta;
this._importPath=e?ob(e.url):(e=O.import(this.is))&&e.assetpath||Object.getPrototypeOf(this.prototype).constructor.importPath}return this._importPath}constructor(){super();this._template;this._importPath;this.rootPath;this.importPath;this.root;this.$}_initializeProperties(){this.constructor.finalize();this.constructor._finalizeTemplate(this.localName);super._initializeProperties();this.rootPath=bf;this.importPath=this.constructor.importPath;var e=this.constructor;if(!e.hasOwnProperty("__propertyDefaults")){e.__propertyDefaults=
...
(f.shadowRoot||(f.attachShadow({mode:"open",shadyUpgradeFragment:e}),f.shadowRoot.appendChild(e),this.constructor._styleSheet&&(f.shadowRoot.adoptedStyleSheets=[this.constructor._styleSheet])),df&&window.ShadyDOM&&window.ShadyDOM.flushInitial(f.shadowRoot),f.shadowRoot):null;throw Error("ShadowDOM not available. PolymerElement can create dom as children instead of in ShadowDOM by setting `this.root \x3d this;` before `ready`.");}updateStyles(e){window.ShadyCSS&&window.ShadyCSS.styleSubtree(this,e)}resolveUrl(e,
...
e,f,g)}}return d}),Ea=function(b,...a){const c=document.createElement("template");c.innerHTML=a.reduce((d,e,f)=>{if(e instanceof HTMLTemplateElement)e=e.innerHTML;else throw Error(`non-template value passed to Polymer's html function: ${e}`);return d+e+b[f+1]},b[0]);return c},M=bb(HTMLElement);class w{constructor(){this._timer=this._callback=this._asyncModule=null}setConfig(b,a){this._asyncModule=b;this._callback=a;this._timer=this._asyncModule.run(()=>{this._timer=null;V.delete(this);this._callback()})}cancel(){this.isActive()&&
(this._cancelAsync(),V.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return null!=this._timer}static debounce(b,a,c){b instanceof w?b._cancelAsync():b=new w;b.setConfig(a,c);return b}}let V=new Set;const uf=function(){const b=!!V.size;V.forEach(a=>{try{a.flush()}catch(c){setTimeout(()=>{throw c;})}});return b};let xb="string"===typeof document.head.style.touchAction,Qa=["mousedown",
"mousemove","mouseup","click"],ze=[0,1,4,2];try{var xd=1===(new MouseEvent("test",{buttons:1})).buttons}catch(b){xd=!1}let ye=xd,yb=!1;(function(){try{let b=Object.defineProperty({},"passive",{get(){yb=!0}});window.addEventListener("test",null,b);window.removeEventListener("test",null,b)}catch(b){}})();let uc=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const zb=[],vf={button:!0,input:!0,keygen:!0,meter:!0,output:!0,textarea:!0,progress:!0,select:!0},Be={button:!0,command:!0,fieldset:!0,
input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};let vc=function(b){var a=b.sourceCapabilities;if(!a||a.firesTouchEvents)if(b.__polymerGesturesHandled={skip:!0},"click"===b.type){a=!1;let f=Ra(b);for(let g=0;g<f.length;g++){if(f[g].nodeType===Node.ELEMENT_NODE)if("label"===f[g].localName)zb.push(f[g]);else if(vf[f[g].localName]){var c=f[g],d=Array.prototype.slice.call(c.labels||[]);if(!d.length){d=[];var e=c.getRootNode();if(c.id)for(c=e.querySelectorAll(`label[for = ${c.id}]`),e=0;e<
c.length;e++)d.push(c[e])}for(c=0;c<d.length;c++)a=a||-1<zb.indexOf(d[c])}if(f[g]===A.mouse.target)return}a||(b.preventDefault(),b.stopPropagation())}},A={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};document.addEventListener("touchend",function(b){A.mouse.mouseIgnoreJob||tc(!0);A.mouse.target=Ra(b)[0];A.mouse.mouseIgnoreJob=w.debounce(A.mouse.mouseIgnoreJob,I.after(2500),function(){tc();A.mouse.target=null;A.mouse.mouseIgnoreJob=null})},yb?{passive:!0}:!1);const Ra=
window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:b=>b.composedPath&&b.composedPath()||[],qa={},aa=[];Bb({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){ba(this.info)},mousedown:function(b){if(Z(b)){var a=P(b),c=this;wc(this.info,function(d){Z(d)||(ra("up",a,d),ba(c.info))},function(d){Z(d)&&ra("up",a,d);ba(c.info)});ra("down",a,b)}},touchstart:function(b){ra("down",
P(b),b.changedTouches[0],b)},touchend:function(b){ra("up",P(b),b.changedTouches[0],b)}});Bb({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(b){2<this.moves.length&&this.moves.shift();this.moves.push(b)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start";this.info.started=!1;this.info.moves=
[];this.info.x=0;this.info.y=0;this.info.prevent=!1;ba(this.info)},mousedown:function(b){if(Z(b)){var a=P(b),c=this,d=function(e){let f=e.clientX,g=e.clientY;zc(c.info,f,g)&&(c.info.state=c.info.started?"mouseup"===e.type?"end":"track":"start","start"===c.info.state&&Sa("tap"),c.info.addMove({x:f,y:g}),Z(e)||(c.info.state="end",ba(c.info)),a&&Db(c.info,a,e),c.info.started=!0)};wc(this.info,d,function(e){c.info.started&&d(e);ba(c.info)});this.info.x=b.clientX;this.info.y=b.clientY}},touchstart:function(b){b=
b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchmove:function(b){let a=P(b);b=b.changedTouches[0];let c=b.clientX,d=b.clientY;zc(this.info,c,d)&&("start"===this.info.state&&Sa("tap"),this.info.addMove({x:c,y:d}),Db(this.info,a,b),this.info.state="track",this.info.started=!0)},touchend:function(b){let a=P(b);b=b.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:b.clientX,y:b.clientY}),Db(this.info,a,b))}});Bb({name:"tap",deps:["mousedown","click",
"touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN;this.info.y=NaN;this.info.prevent=!1},mousedown:function(b){Z(b)&&(this.info.x=b.clientX,this.info.y=b.clientY)},click:function(b){Z(b)&&Ac(this.info,b)},touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchend:function(b){Ac(this.info,b.changedTouches[0],b)}});const Fa=F(b=>{class a extends b{_addEventListenerToNode(c,
d,e){Ab(c,d,e)||super._addEventListenerToNode(c,d,e)}_removeEventListenerFromNode(c,d,e){if(qa[d]){var f=qa[d];var g=f.deps;f=f.name;let h=c.__polymerGestures;if(h)for(let k=0,l,m;k<g.length;k++)l=g[k],(m=h[l])&&m[f]&&(m[f]=(m[f]||1)-1,m._count=(m._count||1)-1,0===m._count&&c.removeEventListener(l,xc,sc(l)));c.removeEventListener(d,e);g=!0}else g=!1;g||super._removeEventListenerFromNode(c,d,e)}}return a}),wf=b=>class extends b{static get properties(){return{theme:{type:String,readOnly:!0}}}attributeChangedCallback(a,
c,d){super.attributeChangedCallback(a,c,d);"theme"===a&&this._setTheme(d)}},Ub=b=>class extends wf(b){static finalize(){super.finalize();const a=this.prototype._template,c=this.template&&this.template.parentElement&&this.template.parentElement.id===this.is,d=Object.getPrototypeOf(this.prototype)._template;d&&!c&&Array.from(d.content.querySelectorAll("style[include]")).forEach(e=>{this._includeStyle(e.getAttribute("include"),a)});this._includeMatchingThemes(a)}static _includeMatchingThemes(a){const c=
O.prototype.modules;let d=!1;const e=this.is+"-default-theme";Object.keys(c).sort((f,g)=>{const h=0===f.indexOf("vaadin-"),k=0===g.indexOf("vaadin-");var l=["lumo-","material-"];const m=0<l.filter(n=>0===f.indexOf(n)).length;l=0<l.filter(n=>0===g.indexOf(n)).length;return h!==k?h?-1:1:m!==l?m?-1:1:0}).forEach(f=>{if(f!==e){const g=c[f].getAttribute("theme-for");g&&g.split(" ").forEach(h=>{(new RegExp("^"+h.split("*").join(".*")+"$")).test(this.is)&&(d=!0,this._includeStyle(f,a))})}});!d&&c[e]&&this._includeStyle(e,
a)}static _includeStyle(a,c){if(c&&!c.content.querySelector(`style[include="${a}"]`)){const d=document.createElement("style");d.setAttribute("include",a);c.content.appendChild(d)}}};let cb=!1;window.addEventListener("keydown",()=>{cb=!0},{capture:!0});window.addEventListener("mousedown",()=>{cb=!1},{capture:!0});const xf=b=>class extends b{static get properties(){var a={tabindex:{type:Number,value:0,reflectToAttribute:!0,observer:"_tabindexChanged"}};window.ShadyDOM&&(a.tabIndex=a.tabindex);return a}},
yf=b=>class extends xf(b){static get properties(){return{autofocus:{type:Boolean},_previousTabIndex:{type:Number},disabled:{type:Boolean,observer:"_disabledChanged",reflectToAttribute:!0},_isShiftTabbing:{type:Boolean}}}get _keyboardActive(){return cb}ready(){this.addEventListener("focusin",c=>{c.composedPath()[0]===this?this.contains(c.relatedTarget)||this._focus():-1===c.composedPath().indexOf(this.focusElement)||this.disabled||this._setFocused(!0)});this.addEventListener("focusout",c=>this._setFocused(!1));
...
this.hasAttribute("focused")&&this._setFocused(!1)}_setFocused(a){a?this.setAttribute("focused",""):this.removeAttribute("focused");a&&cb?this.setAttribute("focus-ring",""):this.removeAttribute("focus-ring")}get focusElement(){window.console.warn(`Please implement the 'focusElement' property in <${this.localName}>`);return this}_focus(){this.focusElement&&!this._isShiftTabbing&&(this.focusElement.focus(),this._setFocused(!0))}focus(){this.focusElement&&!this.disabled&&(this.focusElement.focus(),this._setFocused(!0))}blur(){this.focusElement&&
...
d;break;case "reverse":c.scrollLeft=c.scrollWidth-c.clientWidth-d;break;default:c.scrollLeft=d}else c.scrollLeft=d}}const W=[];let db;(new MutationObserver(function(){const b=ha();W.forEach(a=>{Wb(a,b)})})).observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const Wb=function(b,a){a?b.setAttribute("dir",a):b.removeAttribute("dir")},ha=function(){return document.documentElement.getAttribute("dir")},Xb=b=>class extends b{static get properties(){return{dir:{type:String,readOnly:!0}}}static finalize(){super.finalize();
db||(db=Vb.detectScrollType())}connectedCallback(){super.connectedCallback();this.hasAttribute("dir")||(this.__subscribe(),Wb(this,ha()))}attributeChangedCallback(a,c,d){super.attributeChangedCallback(a,c,d);if("dir"===a){a=d===ha()&&-1===W.indexOf(this);var e=!d&&c&&-1===W.indexOf(this);c=d!==ha()&&c===ha();a||e?(this.__subscribe(),Wb(this,ha())):c&&this.__subscribe(!1)}}disconnectedCallback(){super.disconnectedCallback();this.__subscribe(!1);this.removeAttribute("dir")}__subscribe(a=!0){a?-1===
W.indexOf(this)&&W.push(this):-1<W.indexOf(this)&&W.splice(W.indexOf(this),1)}__getNormalizedScrollLeft(a){return Vb.getNormalizedScrollLeft(db,this.getAttribute("dir")||"ltr",a)}__setNormalizedScrollLeft(a,c){return Vb.setNormalizedScrollLeft(db,this.getAttribute("dir")||"ltr",a,c)}},Ee=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Ta=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;window.Vaadin=window.Vaadin||{};const yd=function(b,a){if(window.Vaadin.developmentMode)return Bc(b,
a)};if(void 0===window.Vaadin.developmentMode){var zf=window.Vaadin;try{var zd=localStorage.getItem("vaadin.developmentmode.force")?!0:0<=["localhost","127.0.0.1"].indexOf(window.location.hostname)?Ta?!De():!Ce():!1}catch(b){zd=!1}zf.developmentMode=zd}const Ad=function(){if("function"===typeof yd)return yd(Fe)};window.Vaadin||(window.Vaadin={});window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{};window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=
function(){Ad&&Ad()};let Yb;const Bd=new Set,Cd=b=>class extends Xb(b){static finalize(){super.finalize();const {is:a}=this;a&&!Bd.has(a)&&(window.Vaadin.registrations.push(this),Bd.add(a),window.Vaadin.developmentModeCallback&&(Yb=w.debounce(Yb,od,()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()}),V.add(Yb)))}constructor(){super();null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add \x3c!DOCTYPE html\x3e to the HTML document.')}};
class Dd extends Cd(yf(Ub(Fa(M)))){static get template(){return Ea`
      <style>
        :host {
          display: inline-block;
        }
...
"a"===b.target.localName?!1:!0}_handleClick(b){this.__interactionsAllowed(b)&&(this.indeterminate?(this.indeterminate=!1,b.preventDefault(),this._toggleChecked()):b.composedPath()[0]!==this._nativeCheckbox&&(b.preventDefault(),this._toggleChecked()))}_toggleChecked(){this.checked=!this.checked;this.dispatchEvent(new CustomEvent("change",{composed:!1,bubbles:!0}))}}customElements.define(Dd.is,Dd);Ca("vaadin-grid",Ba`
  ...
  `,{moduleId:"vaadin-grid-select-all-checkbox-lumo"});let Ua=!1,Dc=[],Ec=[];class Ic{constructor(){this.end=this.start=0;this.rules=this.parent=this.previous=null;this.cssText=this.parsedCssText="";this.atRule=!1;this.type=0;this.parsedSelector=this.selector=this.keyframesName=""}}const Q={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,MIXIN_RULE:1E3},K={comments:/\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,customProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,mixinProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
mixinApply:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,varApply:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,keyframesRule:/^@[^\s]*keyframes/,multipleSpaces:/\s+/g},Ed=new Set;window.ShadyDOM&&window.ShadyDOM.wrap||(b=>b);const Af=/;\s*/m,Bf=/^\s*(initial)|(inherit)\s*$/,Fd=/\s*!important/;class Cf{constructor(){this._map={}}set(b,a){b=b.trim();this._map[b]={properties:a,dependants:{}}}get(b){b=b.trim();return this._map[b]||null}}let eb=null;class D{constructor(){this._measureElement=this._currentElement=
null;this._map=new Cf}detectMixin(b){b=Wa.test(b)||Nb.test(b);Wa.lastIndex=0;Nb.lastIndex=0;return b}gatherStyles(b){var a=[];var c=b.content.querySelectorAll("style");for(let d=0;d<c.length;d++){const e=c[d];if(e.hasAttribute("shady-unscoped")){if(!La){const f=e.textContent;if(!Ed.has(f)){Ed.add(f);const g=document.createElement("style");g.setAttribute("shady-unscoped","");g.textContent=f;document.head.appendChild(g)}e.parentNode.removeChild(e)}}else a.push(e.textContent),e.parentNode.removeChild(e)}return(a=
a.join("").trim())?(c=document.createElement("style"),c.textContent=a,b.content.insertBefore(c,b.content.firstChild),c):null}transformTemplate(b,a){void 0===b._gatheredStyle&&(b._gatheredStyle=this.gatherStyles(b));return(b=b._gatheredStyle)?this.transformStyle(b,a):null}transformStyle(b,a=""){let c=Kc(b);this.transformRules(c,a);b.textContent=Eb(c);return c}transformCustomStyle(b){let a=Kc(b);sa(a,c=>{":root"===c.selector&&(c.selector="html");this.transformRule(c)});b.textContent=Eb(a);return a}transformRules(b,
...
nativeCss:Fb,nativeShadow:La,cssBuild:ta,disableRuntime:bd};a&&(window.ShadyCSS.CustomStyleInterface=a)}window.ShadyCSS.ApplyShim=Ga;const Ef=/:host\(:dir\((ltr|rtl)\)\)/g,Ff=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Gf=/:dir\((?:ltr|rtl)\)/,Gd=!(!window.ShadyDOM||!window.ShadyDOM.inUse),va=[];let Ha=null,ua="";const Hf=F(b=>{Gd||Ha||(ua=document.documentElement.getAttribute("dir"),Ha=new MutationObserver(Oc),Ha.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const a=rd(b);
class c extends a{static _processStyleText(d,e){d=a._processStyleText.call(this,d,e);!Gd&&Gf.test(d)&&(d=this._replaceDirInCssText(d),this.__activateDir=!0);return d}static _replaceDirInCssText(d){d=d.replace(Ef,':host([dir\x3d"$1"])');return d=d.replace(Ff,':host([dir\x3d"$2"]) $1')}constructor(){super();this.__autoDirOptOut=!1}ready(){super.ready();this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){a.prototype.connectedCallback&&super.connectedCallback();this.constructor.__activateDir&&
(Ha&&Ha.takeRecords().length&&Oc(),va.push(this),this.__autoDirOptOut||this.setAttribute("dir",ua))}disconnectedCallback(){a.prototype.disconnectedCallback&&super.disconnectedCallback();if(this.constructor.__activateDir){const d=va.indexOf(this);-1<d&&va.splice(d,1)}}}c.__activateDir=!1;return c});"interactive"===document.readyState||"complete"===document.readyState?Pc():window.addEventListener("DOMContentLoaded",Pc);let N=class{static getFlattenedNodes(b){const a=q(b);return ca(b)?a.assignedNodes({flatten:!0}):
Array.from(a.childNodes).map(c=>ca(c)?q(c).assignedNodes({flatten:!0}):[c]).reduce((c,d)=>c.concat(d),[])}constructor(b,a){this._nativeChildrenObserver=this._shadyChildrenObserver=null;this._connected=!1;this._target=b;this.callback=a;this._effectiveNodes=[];this._observer=null;this._scheduled=!1;this._boundSchedule=()=>{this._schedule()};this.connect();this._schedule()}connect(){ca(this._target)?this._listenSlots([this._target]):q(this._target).children&&(this._listenSlots(q(this._target).children),
window.ShadyDOM?this._shadyChildrenObserver=window.ShadyDOM.observeChildren(this._target,b=>{this._processMutations(b)}):(this._nativeChildrenObserver=new MutationObserver(b=>{this._processMutations(b)}),this._nativeChildrenObserver.observe(this._target,{childList:!0})));this._connected=!0}disconnect(){ca(this._target)?this._unlistenSlots([this._target]):q(this._target).children&&(this._unlistenSlots(q(this._target).children),window.ShadyDOM&&this._shadyChildrenObserver?(window.ShadyDOM.unobserveChildren(this._shadyChildrenObserver),
...
{"activeElement"!=a&&(b.prototype[a]=u.prototype[a])});Rc(b.prototype,["classList"]);$b=b;Object.defineProperties(Zb.prototype,{localTarget:{get(){var a=this.event.currentTarget;a=a&&X(a).getOwnerRoot();const c=this.path;for(let d=0;d<c.length;d++){const e=c[d];if(X(e).getOwnerRoot()===a)return e}},configurable:!0},path:{get(){return window.ShadyDOM.composedPath(this.event)},configurable:!0}})}else Pe(u.prototype,"cloneNode appendChild insertBefore removeChild replaceChild setAttribute removeAttribute querySelector querySelectorAll".split(" ")),
Rc(u.prototype,"parentNode firstChild lastChild nextSibling previousSibling firstElementChild lastElementChild nextElementSibling previousElementSibling childNodes children classList".split(" ")),Qe(u.prototype,["textContent","innerHTML","className"]);const X=function(b){b=b||document;if(b instanceof $b||b instanceof Zb)return b;let a=b.__domApi;a||(a=b instanceof Event?new Zb(b):new $b(b),b.__domApi=a);return a},Hb=window.ShadyDOM,Sc=window.ShadyCSS,Id=b=>{for(;b;){const a=Object.getOwnPropertyDescriptor(b,
"observedAttributes");if(a)return a.get;b=Object.getPrototypeOf(b.prototype).constructor}return()=>[]};F(b=>{b=bb(b);let a=Id(b);class c extends b{constructor(){super();this.__isUpgradeDisabled}static get observedAttributes(){return a.call(this).concat("disable-upgrade")}_initializeProperties(){this.hasAttribute("disable-upgrade")?this.__isUpgradeDisabled=!0:super._initializeProperties()}_enableProperties(){this.__isUpgradeDisabled||super._enableProperties()}_canApplyPropertyDefault(d){return super._canApplyPropertyDefault(d)&&
!(this.__isUpgradeDisabled&&this._isPropertyPending(d))}attributeChangedCallback(d,e,f,g){"disable-upgrade"==d?this.__isUpgradeDisabled&&null==f&&(super._initializeProperties(),this.__isUpgradeDisabled=!1,q(this).isConnected&&super.connectedCallback()):super.attributeChangedCallback(d,e,f,g)}connectedCallback(){this.__isUpgradeDisabled||super.connectedCallback()}disconnectedCallback(){this.__isUpgradeDisabled||super.disconnectedCallback()}}return c});let If=window.ShadyCSS;const Jd=F(b=>{b=Fa(bb(b));
b=Tb?b:Hf(b);const a=Id(b),c={x:"pan-x",y:"pan-y",none:"none",all:"auto"};class d extends b{constructor(){super();this.isAttached;this.__boundListeners;this._debouncers;this.__isUpgradeDisabled;this.__needsAttributesAtConnected;this._legacyForceObservedAttributes}static get importMeta(){return this.prototype.importMeta}created(){}__attributeReaction(e,f,g){(this.__dataAttributes&&this.__dataAttributes[e]||"disable-upgrade"===e)&&this.attributeChangedCallback(e,f,g,null)}setAttribute(e,f){if(Ya&&!this._legacyForceObservedAttributes){const g=
this.getAttribute(e);super.setAttribute(e,f);this.__attributeReaction(e,g,String(f))}else super.setAttribute(e,f)}removeAttribute(e){if(Ya&&!this._legacyForceObservedAttributes){const f=this.getAttribute(e);super.removeAttribute(e);this.__attributeReaction(e,f,null)}else super.removeAttribute(e)}static get observedAttributes(){return Ya&&!this.prototype._legacyForceObservedAttributes?(this.hasOwnProperty("__observedAttributes")||(this.__observedAttributes=[]),this.__observedAttributes):a.call(this).concat("disable-upgrade")}_enableProperties(){this.__isUpgradeDisabled||
...
g=f+g;let k=h&&h[g];k&&(this._removeEventListenerFromNode(e,f,k),h[g]=null)}setScrollDirection(e,f){yc(f||this,c[e]||"auto")}$$(e){return this.root.querySelector(e)}get domHost(){let e=q(this).getRootNode();return e instanceof DocumentFragment?e.host:e}distributeContent(){const e=X(this);window.ShadyDOM&&e.shadowRoot&&ShadyDOM.flush()}getEffectiveChildNodes(){return X(this).getEffectiveChildNodes()}queryDistributedElements(e){return X(this).queryDistributedElements(e)}getEffectiveChildren(){return this.getEffectiveChildNodes().filter(function(e){return e.nodeType===
Node.ELEMENT_NODE})}getEffectiveTextContent(){let e=this.getEffectiveChildNodes(),f=[];for(let g=0,h;h=e[g];g++)h.nodeType!==Node.COMMENT_NODE&&f.push(h.textContent);return f.join("")}queryEffectiveChildren(e){return(e=this.queryDistributedElements(e))&&e[0]}queryAllEffectiveChildren(e){return this.queryDistributedElements(e)}getContentChildNodes(e){return(e=this.root.querySelector(e||"slot"))?X(e).getDistributedNodes():[]}getContentChildren(e){return this.getContentChildNodes(e).filter(function(f){return f.nodeType===
Node.ELEMENT_NODE})}isLightDescendant(e){return this!==e&&q(this).contains(e)&&q(this).getRootNode()===q(e).getRootNode()}isLocalDescendant(e){return this.root===q(e).getRootNode()}scopeSubtree(e,f=!1){return Re(e,f)}getComputedStyleValue(e){return If.getComputedStyleValue(this,e)}debounce(e,f,g){this._debouncers=this._debouncers||{};return this._debouncers[e]=w.debounce(this._debouncers[e],0<g?I.after(g):G,f.bind(this))}isDebouncerActive(e){this._debouncers=this._debouncers||{};e=this._debouncers[e];
return!(!e||!e.isActive())}flushDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.flush()}cancelDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.cancel()}async(e,f){return 0<f?I.run(e.bind(this),f):~G.run(e.bind(this))}cancelAsync(e){0>e?G.cancel(~e):I.cancel(e)}create(e,f){e=document.createElement(e);if(f)if(e.setProperties)e.setProperties(f);else for(let g in f)e[g]=f[g];return e}elementMatches(e,f){return Hd.call(f||this,e)}toggleAttribute(e,
...
1)}else if(f=C(this,e).indexOf(f),0<=f)return this.splice(e,f,1);return null}_logger(e,f){Array.isArray(f)&&1===f.length&&Array.isArray(f[0])&&(f=f[0]);switch(e){case "log":case "warn":case "error":console[e](...f)}}_log(...e){this._logger("log",e)}_warn(...e){this._logger("warn",e)}_error(...e){this._logger("error",e)}_logf(e,...f){return["[%s::%s]",this.is,e,...f]}}d.prototype.is="";return d}),Se={attached:!0,detached:!0,ready:!0,created:!0,beforeRegister:!0,registered:!0,attributeChanged:!0,listeners:!0,
hostAttributes:!0},Wc={attached:!0,detached:!0,ready:!0,created:!0,beforeRegister:!0,registered:!0,attributeChanged:!0,behaviors:!0,_noAccessors:!0},Ue=Object.assign({listeners:!0,hostAttributes:!0,properties:!0,observers:!0},Wc),Kd=Jd(HTMLElement),ac=F(b=>{class a extends b{_shouldPropertyChange(c,d,e){return Ib(this,c,d,e,!0)}}return a}),Ld=F(b=>{class a extends b{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(c,d,e){return Ib(this,c,d,e,this.mutableData)}}return a});
ac._mutablePropertyChange=Ib;let Kb=null;Jb.prototype=Object.create(HTMLTemplateElement.prototype,{constructor:{value:Jb,writable:!0}});const Zc=ab(Jb),Ze=ac(Zc),Jf=ab(class{});class R extends Jf{constructor(b){super();this._configureProperties(b);this.root=this._stampTemplate(this.__dataHost);var a=[];this.children=a;for(let c=this.root.firstChild;c;c=c.nextSibling)a.push(c),c.__templatizeInstance=this;this.__templatizeOwner&&this.__templatizeOwner.__hideTemplateChildren__&&this._showHideChildren(!0);
...
R.prototype.__dataHost;R.prototype.__templatizeOptions;R.prototype._methodHost;R.prototype.__templatizeOwner;R.prototype.__hostProps;const Ye=ac(R);let ad=!1;const Kf=Fa(Ld(ab(HTMLElement)));class Lf extends Kf{static get observedAttributes(){return["mutable-data"]}constructor(){super();if(da)throw Error("strictTemplatePolicy: dom-bind not allowed");this.__children=this.$=this.root=null}attributeChangedCallback(b,a,c,d){this.mutableData=!0}connectedCallback(){Lb()||(this.style.display="none");this.render()}disconnectedCallback(){this.__removeChildren()}__insertChildren(){q(q(this).parentNode).insertBefore(this.root,
...
a.nextSibling)this.__children[this.__children.length]=a;this._enableProperties()}this.__insertChildren();this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}}customElements.define("dom-bind",Lf);const Mf=Ld(M);class Md extends Mf{static get is(){return"dom-repeat"}static get template(){return null}static get properties(){return{items:{type:Array},as:{type:String,value:"item"},indexAs:{type:String,value:"index"},itemsIndexAs:{type:String,value:"itemsIndex"},sort:{type:Function,
...
!this.if;this.__instance&&!!this.__instance.__hidden!==b&&(this.__instance.__hidden=b,this.__instance._showHideChildren(b));b||this.__syncHostProperties()}}const Od=dd?Nf:Of;customElements.define(Od.is,Od);let Pf=F(b=>{b=bb(b);class a extends b{static get properties(){return{items:{type:Array},multi:{type:Boolean,value:!1},selected:{type:Object,notify:!0},selectedItem:{type:Object,notify:!0},toggle:{type:Boolean,value:!1}}}static get observers(){return["__updateSelection(multi, items.*)"]}constructor(){super();
...
this.__selectedMap.clear(),this.__selectedMap.set(d,c),this.__updateLinks(),this.multi?this.push("selected",d):this.selected=this.selectedItem=d)}}return a})(M);class Pd extends Pf{static get is(){return"array-selector"}static get template(){return null}}customElements.define(Pd.is,Pd);const ja=Jd(HTMLElement).prototype;var fb=new Set;const Qf={properties:{_parentResizable:{type:Object,observer:"_parentResizableChanged"},_notifyingDescendant:{type:Boolean,value:!1}},listeners:{"iron-request-resize-notifications":"_onIronRequestResizeNotifications"},
created:function(){this._interestedResizables=[];this._boundNotifyResize=this.notifyResize.bind(this);this._boundOnDescendantIronResize=this._onDescendantIronResize.bind(this)},attached:function(){this._requestResizeNotifications()},detached:function(){this._parentResizable?this._parentResizable.stopResizeNotificationsFor(this):(fb.delete(this),window.removeEventListener("resize",this._boundNotifyResize));this._parentResizable=null},notifyResize:function(){this.isAttached&&(this._interestedResizables.forEach(function(b){this.resizerShouldNotify(b)&&
...
b()})}else this._findParent(),this._parentResizable?this._parentResizable._interestedResizables.forEach(function(a){a!==this&&a._findParent()},this):(fb.forEach(function(a){a!==this&&a._findParent()},this),window.addEventListener("resize",this._boundNotifyResize),this.notifyResize())},_findParent:function(){this.assignParentResizable(null);this.fire("iron-request-resize-notifications",null,{node:this,bubbles:!0,cancelable:!0});this._parentResizable?fb.delete(this):fb.add(this)}},Rf={properties:{scrollTarget:{type:HTMLElement,
value:function(){return this._defaultScrollTarget}}},observers:["_scrollTargetChanged(scrollTarget, isAttached)"],_shouldHaveListener:!0,_scrollTargetChanged:function(b,a){this._oldScrollTarget&&(this._toggleScrollListener(!1,this._oldScrollTarget),this._oldScrollTarget=null);a&&("document"===b?this.scrollTarget=this._doc:"string"===typeof b?this.scrollTarget=(a=this.domHost)&&a.$?a.$[b]:X(this.ownerDocument).querySelector("#"+b):this._isValidScrollTarget()&&(this._oldScrollTarget=b,this._toggleScrollListener(this._shouldHaveListener,
...
(a.removeEventListener("scroll",this._boundScrollHandler),this._boundScrollHandler=null)},toggleScrollListener:function(b){this._shouldHaveListener=b;this._toggleScrollListener(b,this.scrollTarget)}},Qd=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),Sf=Qd&&8<=Qd[1],Tf=function(b,a){b||console.warn("Polymer.Class requires `info` argument");a=a?a(Kd):Kd;a=Te(b,a,b.behaviors);a.is=a.prototype.is=b.is;return a}({behaviors:[Qf,Rf],_ratio:.5,_scrollerPaddingTop:0,_scrollPosition:0,_physicalSize:0,
...
e-1);a-=f.effectiveSize}return{cache:this,scaledIndex:a}}},$f=b=>class extends b{static get properties(){return{pageSize:{type:Number,value:50,observer:"_pageSizeChanged"},dataProvider:{type:Object,notify:!0,observer:"_dataProviderChanged"},loading:{type:Boolean,notify:!0,readOnly:!0,reflectToAttribute:!0},_cache:{type:Object,value:function(){return new Rd(this)}},itemIdPath:{type:String,value:null},expandedItems:{type:Object,notify:!0,value:()=>[]}}}static get observers(){return["_sizeChanged(size)",
...
this._hasData=!0;delete c.pendingRequests[a];this._debouncerApplyCachedData=w.debounce(this._debouncerApplyCachedData,I.after(0),()=>{this._setLoading(!1);this._cache.updateSize();this._effectiveSize=this._cache.effectiveSize;Array.from(this.$.items.children).filter(h=>!h.hidden).forEach(h=>{this._cache.getItemForIndex(h.index)&&this._getItem(h.index,h)});this._increasePoolIfNeeded(0);this.__scrollToPendingIndex()});this._cache.isLoading()||this._debouncerApplyCachedData.flush();this.__itemsReceived()})}}_getPageForIndex(a){return Math.floor(a/
...
c){void 0!==c&&this.clearCache();a&&this.items&&this.items.length&&this._scrollToIndex(this._firstVisibleIndex);this._ensureFirstPageLoaded();this._debouncerCheckSize=w.debounce(this._debouncerCheckSize,I.after(2E3),this._checkSize.bind(this));this._scrollHandler()}_ensureFirstPageLoaded(){this._hasData||this._loadPage(0,this._cache)}_itemsEqual(a,c){return this.getItemId(a)===this.getItemId(c)}_getItemIndexInArray(a,c){let d=-1;c.forEach((e,f)=>{this._itemsEqual(e,a)&&(d=f)});return d}scrollToIndex(a){super.scrollToIndex(a);
isNaN(a)||!this._cache.isLoading()&&this.clientHeight||(this.__pendingScrollToIndex=a)}__scrollToPendingIndex(){if(this.__pendingScrollToIndex&&this.$.items.children.length){const a=this.__pendingScrollToIndex;delete this.__pendingScrollToIndex;this._debounceIncreasePool&&this._debounceIncreasePool.flush();this.scrollToIndex(a)}}},ag=b=>class extends b{ready(){super.ready();this._addNodeObserver()}_hasColumnGroups(a){for(let c=0;c<a.length;c++)if("vaadin-grid-column-group"===a[c].localName)return!0;
...
value:a.value}))}};class gb extends M{static get is(){return"vaadin-grid-templatizer"}static get properties(){return{dataHost:Object,template:Object,_templateInstances:{type:Array,value:function(){return[]}},_parentPathValues:{value:function(){return{}}},_grid:Object}}static get observers(){return["_templateInstancesChanged(_templateInstances.*, _parentPathValues.*)"]}constructor(){super();this._instanceProps={detailsOpened:!0,index:!0,item:!0,selected:!0,expanded:!0,level:!0}}createInstance(){this._ensureTemplatized();
...
{for(let e=a;e<a+c;e++)this._templateInstances[e].set(d,this._parentPathValues[d])})}}customElements.define(gb.is,gb);const dg=b=>class extends b{static get properties(){return{detailsOpenedItems:{type:Array,value:function(){return[]}},_rowDetailsTemplate:Object,rowDetailsRenderer:Function,_detailsCells:{type:Array}}}static get observers(){return["_detailsOpenedItemsChanged(detailsOpenedItems.*, _rowDetailsTemplate, rowDetailsRenderer)","_rowDetailsTemplateOrRendererChanged(_rowDetailsTemplate, rowDetailsRenderer)"]}_rowDetailsTemplateOrRendererChanged(a,
c){if(a&&c)throw Error("You should only use either a renderer or a template for row details");if(a||c)a&&!a.templatizer&&(c=new gb,c._grid=this,c.dataHost=this.dataHost,c.template=a,a.templatizer=c),this._columnTree&&Array.from(this.$.items.children).forEach(d=>{d.querySelector("[part~\x3ddetails-cell]")||(this._updateRow(d,this._columnTree[this._columnTree.length-1]),this._a11yUpdateRowDetailsOpened(d,!1));delete d.querySelector("[part~\x3ddetails-cell]")._instance}),this.detailsOpenedItems.length&&
...
this._updateItem(a,c)),fa(),a.style.setProperty("padding-bottom",`${d.offsetHeight}px`),requestAnimationFrame(()=>this.notifyResize()));f&&(this._updateMetrics(),this._positionItems())}}_updateDetailsCellHeights(){Array.from(this.$.items.querySelectorAll('[part~\x3d"details-cell"]:not([hidden])')).forEach(a=>{a.parentElement.style.setProperty("padding-bottom",`${a.offsetHeight}px`)})}_isDetailsOpened(a){return this.detailsOpenedItems&&-1!==this._getItemIndexInArray(a,this.detailsOpenedItems)}openItemDetails(a){this._isDetailsOpened(a)||
this.push("detailsOpenedItems",a)}closeItemDetails(a){this._isDetailsOpened(a)&&this.splice("detailsOpenedItems",this._getItemIndexInArray(a,this.detailsOpenedItems),1)}_detailsOpenedInstanceChangedCallback(a,c){c?this.openItemDetails(a.item):this.closeItemDetails(a.item)}},eg=b=>class extends b{static get properties(){return{_frozenCells:{type:Array,value:()=>[]},_rowWithFocusedElement:Element,_deltaYAcc:{type:Number,value:0},_useSticky:{type:Boolean,value:window.CSS&&window.CSS.supports&&(window.CSS.supports("position",
...
({path:a.path,direction:a.direction}))}_removeArrayItem(a,c){c=a.indexOf(c);-1<c&&a.splice(c,1)}},hg=b=>class extends b{static get properties(){return{cellClassNameGenerator:Function}}static get observers(){return["__cellClassNameGeneratorChanged(cellClassNameGenerator)"]}__cellClassNameGeneratorChanged(){this.generateCellClassNames()}generateCellClassNames(){Array.from(this.$.items.children).filter(a=>!a.hidden).forEach(a=>this._generateCellClassNames(a,this.__getRowModel(a)))}_generateCellClassNames(a,
c){Array.from(a.children).forEach(d=>{d.__generatedClasses&&d.__generatedClasses.forEach(e=>d.classList.remove(e));if(this.cellClassNameGenerator){const e=this.cellClassNameGenerator(d._column,c);d.__generatedClasses=e&&e.split(" ").filter(f=>0<f.length);d.__generatedClasses&&d.__generatedClasses.forEach(f=>d.classList.add(f))}})}},ig=b=>class extends b{static get properties(){return{dropMode:String,rowsDraggable:Boolean,dragFilter:Function,dropFilter:Function,__dndAutoScrollThreshold:{value:50}}}static get observers(){return["_dragDropAccessChanged(rowsDraggable, dropMode, dragFilter, dropFilter)"]}ready(){super.ready();
...
!a.hidden).forEach(a=>{this._filterDragAndDrop(a,this.__getRowModel(a))})}_filterDragAndDrop(a,c){const d=!this.rowsDraggable||this.dragFilter&&!this.dragFilter(c);c=!this.dropMode||this.dropFilter&&!this.dropFilter(c);Array.from(a.children).map(e=>e._content).forEach(e=>{d?e.removeAttribute("draggable"):e.setAttribute("draggable",!0)});this._toggleAttribute("drag-disabled",d,a);this._toggleAttribute("drop-disabled",c,a)}},jg=b=>class extends b{static get properties(){return{_headerFocusable:{type:Object,
...
a&&(this.$.table.scrollLeft+=Math.round(c.left-a));c.right>f&&(this.$.table.scrollLeft+=Math.round(c.right-f))}}_elementMatches(a,c){return a.matches?a.matches(c):-1!==Array.from(a.parentNode.querySelectorAll(c)).indexOf(a)}},kg=b=>class extends Fa(b){static get properties(){return{columnReorderingAllowed:{type:Boolean,value:!1},_orderBaseScope:{type:Number,value:1E7}}}static get observers(){return["_updateOrders(_columnTree, _columnTree.*)"]}ready(){super.ready();Ab(this,"track",this._onTrackEvent);
...
a._order=c._order;c._order=d;this._updateLastFrozen();this._updateFirstAndLastColumn()}_getTargetColumn(a,c){if(a&&c){let d=a._column;for(;d.parentElement!==c.parentElement&&d!==this;)d=d.parentElement;return d.parentElement===c.parentElement?d:a._column}}},Sd=b=>class extends b{static get properties(){return{resizable:{type:Boolean,value:function(){if("vaadin-grid-column-group"!==this.localName){var a=this.parentNode;return a&&"vaadin-grid-column-group"===a.localName?a.resizable||!1:!1}}},_headerTemplate:{type:Object},
...
this._previousHidden=a}};class hb extends Sd(Xb(M)){static get is(){return"vaadin-grid-column"}static get properties(){return{width:{type:String,value:"100px"},flexGrow:{type:Number,value:1},renderer:Function,path:{type:String},autoWidth:{type:Boolean,value:!1},_bodyTemplate:{type:Object},_cells:Array}}}customElements.define(hb.is,hb);Ca("vaadin-grid",Ba`
  ...
  `,{moduleId:"vaadin-grid-styles"});try{document.createEvent("TouchEvent");var Td=!0}catch(b){Td=!1}const lg=Td;class Ud extends Cd(Ub($f(Yf(ag(Xf(eg(fg(gg(dg(jg(Vf(cg(kg(Zf(bg(ig(hg(Uf)))))))))))))))))){static get template(){return Ea`
      <div
        id="scroller"
        safari$="[[_safari]]"
        ios$="[[_ios]]"
...
d.setAttribute("part","row");d.setAttribute("role","row");this._columnTree&&this._updateRow(d,this._columnTree[this._columnTree.length-1],"body",!1,!0);a.push(d)}this._columnTree&&this._columnTree[this._columnTree.length-1].forEach(c=>c.isConnected&&c.notifyPath&&c.notifyPath("_cells.*",c._cells));He(this,()=>{this._updateFirstAndLastColumn();this._resetKeyboardNavigation()});return a}_getRowTarget(){return this.$.items}_createCell(b){const a="vaadin-grid-cell-content-"+(this._contentIndex=this._contentIndex+
...
{if(d._renderer){const e=d._column||this;d._renderer.call(e,d._content,e,c)}else d._instance&&(d._instance.__detailsOpened__=c.detailsOpened,d._instance.__selected__=c.selected,d._instance.__level__=c.level,d._instance.__expanded__=c.expanded,d._instance.setProperties(c))});this._debouncerUpdateHeights=w.debounce(this._debouncerUpdateHeights,I.after(1),()=>{this._updateMetrics();this._positionItems();this._updateScrollerSize()})}_resizeHandler(){this._updateDetailsCellHeights();this._accessIronListAPI(super._resizeHandler,
...
!Array.isArray(this._grid.items)}}customElements.define(Wd.is,Wd);Ca("vaadin-grid-sorter",Ba`
    :host {
...
"asc"===this.direction?"desc":"desc"===this.direction?null:"asc")}}customElements.define(Yd.is,Yd);class Zd extends hb{static get template(){return Ea`
      <template class="header" id="headerTemplate">
        <vaadin-grid-sorter path="[[path]]" direction="{{direction}}">[[_getHeader(header, path)]]</vaadin-grid-sorter>
      </template>
    `}static get is(){return"vaadin-grid-sort-column"}static get properties(){return{path:String,direction:{type:String,notify:!0}}}_prepareHeaderTemplate(){const b=this._prepareTemplatizer(this.$.headerTemplate);b.templatizer.dataHost=this;return b}_getHeader(b,a){return b||this._generateHeader(a)}}customElements.define(Zd.is,Zd);const $d={selectionColumn:!0,columnMenus:!0};let x=function(b){function a(d,e){d=b.call(this,d,e)||this;d._grid=null;d._headerStyles="display: flex; font-weight: 400;";
d._hostStyles='font-family: "Avenir Next", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 1em; background-color: inherit; color: inherit;';d._rowHoverStyles="background-color: var(--lumo-row-background-hover);";d._columnElements=[];d._isDataLoaded=!1;d.itemIdPath=null;d.messages=null;d.viewModel=new ee;d.visibleElements={...$d};return d}ib._inheritsLoose(a,b);var c=a.prototype;c.initialize=function(){this.handles.add([this.columns.on("change",()=>this._syncColumnRenderers()),Ka.watch(()=>
this.viewModel?.size,()=>this._updateGridSize()),Ka.watch(()=>this.store?.state,(d,e)=>{"ready"!==d||"loaded"!==e&&"error"!==e||this.refreshPageCache()}),Ka.on(()=>this.highlightIds,"change",d=>{const {added:e,removed:f}=d;d=e.map(h=>this.store?.getLocalItemByKey(h)||{objectId:h});const g=f.map(h=>this.store?.getLocalItemByKey(h)||{objectId:h});this._deselectRows(g);this._selectRows(d)}),Ka.on(()=>this._grid?.$?.table,"scroll",()=>this.viewModel?.closeColumnMenus())])};c.destroy=function(){this.handles.removeAll();
this.resetColumns();this.columns?.destroy()};c.resetColumns=function(){this.columns.items.forEach(d=>d.destroy());this.columns.removeAll()};c.castVisibleElements=function(d){return{...$d,...d}};c.render=function(){const {columnMenus:d}=this.visibleElements;return Y.tsx("div",{bind:this,class:this.classes("esri-grid","esri-widget",{["esri-grid--no-column-menu"]:!d})},Y.tsx("div",{bind:this,class:"esri-grid__content"},this.renderGrid()))};c.renderGrid=function(){return Y.tsx("vaadin-grid",{...this.getGridProps()},
this.renderAllColumns())};c.renderAllColumns=function(){if("disabled"!==this.viewModel.state&&this.columns&&this.columns.length)return[this.renderSelectionColumn(),this.renderColumns()]};c.renderSelectionColumn=function(){return Y.tsx("vaadin-grid-selection-column",{_selectAllHidden:!0,selectAll:!1,bind:this,hidden:!this.visibleElements.selectionColumn,sortable:!1,frozen:!fe.isRTL(this.container)})};c.renderColumns=function(){return this.columns.items.map((d,e)=>"columns"in d?this.renderGroupColumn(d,
e):Y.tsx("vaadin-grid-column",{...this.getColumnProps(d,e)}))};c.renderGroupColumn=function(d,e){const f=this.getColumnProps(d,e);if(!f.hidden)return Y.tsx("vaadin-grid-column-group",{...f},d.columns?.map(g=>Y.tsx("vaadin-grid-column",{...this.getColumnProps(g,e)})))};c.getGridProps=function(){const {columnReorderingEnabled:d,id:e,multiSortEnabled:f,pageSize:g,size:h}=this;return{_safari:!1,class:"esri-grid__grid",id:`${e}_grid`,theme:"compact column-borders",ref:"grid",bind:this,afterCreate:this._afterGridCreate,
afterUpdate:this._afterGridUpdate,columnReorderingAllowed:d,pageSize:g,size:h,multiSort:f}};c.getColumnProps=function(d,e){const {id:f}=this,{autoWidth:g,direction:h,flexGrow:k,frozen:l,header:m,hidden:n,path:p,resizable:r,textAlign:v,width:B}=d;d=`${f}_${m}_${Ja.isSome(e)?e:p}`;return{autoWidth:g,direction:h,flexGrow:k,frozen:l,header:m,hidden:n,key:d,path:p,resizable:r,"text-align":v,width:"number"===typeof B?`${B}px`:B,bind:this,afterCreate:this._afterColumnCreate,afterRemoved:this._afterColumnRemoved}};
c.clearSelection=function(){this._clearSelection();this.scheduleRender()};c.clearSort=function(){let d=!1;this._grid&&(this._grid._sorters?.length&&(this._grid._sorters.forEach(e=>{e._order=null;e.direction=null}),d=!0),this.columns?.length&&this.columns.some(e=>!!e.direction)&&(this.columns.forEach(e=>e.direction=null),d=!0),d&&(this.notifyChange("sortOrders"),this.scheduleRender()))};c.findColumn=function(d){this.viewModel.findColumn(d)};c.generateCellClassNames=function(){this._grid?.generateCellClassNames()};
c.getSlotElementByName=function(d){return this._grid?.shadowRoot?.querySelector(`slot[name='${d}']`)??null};c.hideColumn=function(d){this.viewModel?.hideColumn(d);this.scheduleRender()};c.notifyResize=function(){this._grid?.notifyResize()};c.recalculateColumnWidths=function(){this._grid?.recalculateColumnWidths()};c.reset=function(){var d=ib._asyncToGenerator(function*(){this._isDataLoaded=!1;this._clearSelection();yield this.store?.reset();this.scrollToTop()});return function(){return d.apply(this,
arguments)}}();c.refreshPageCache=function(){this._grid?.clearCache()};c.selectRows=function(d){d=d?.filter(f=>!this.highlightIds.includes(f.objectId));const e=d.map(f=>f.objectId);e.length&&(this.highlightIds.addMany(e),this._selectRows(d))};c.deselectRows=function(d){const e=d?.map(f=>f.objectId)||[];e.length&&(this.highlightIds.removeMany(e),this._deselectRows(d))};c.showColumn=function(d){this.viewModel?.showColumn(d);this.scheduleRender()};c.sort=function({path:d,direction:e}){this.viewModel?.sortColumn(d,
e);this.notifyChange("sortOrders")};c.scrollToIndex=function(d){this._grid?.scrollToIndex(d)};c.scrollToTop=function(){this._grid?.scrollToIndex(0)};c.isEditingActive=function(){return!!this._getActiveEditInfo().length};c._afterGridCreate=function(d){const {cellClassNameGenerator:e,dataProvider:f,itemIdPath:g,rowDetailsRenderer:h}=this;d.cellClassNameGenerator=e;d.dataProvider=f;d.rowDetailsRenderer=h;d.itemIdPath=g;const k=this._grid=d;customElements.whenDefined("vaadin-grid").then(()=>{this._appendStyles();
this._addGridEventListeners()});k.__updateSorter=l=>{var m=k._sorters;const n=!m.includes(l);if(l.direction||!n)l._order=null,k.multiSort?(k._removeArrayItem(m,l),l.direction&&(Ja.isSome(l._initialOrder)?(n?m[l._initialOrder]=l:m.splice(l._initialOrder,0,l),l._initialOrder=null):m.unshift(l)),k.__updateSortOrders()):l.direction&&(m=m.filter(p=>p!==l),k._sorters=[l],m.forEach(p=>{p._order=null;p.direction=null}))}};c._afterGridUpdate=function(d){this._grid||(this._grid=d)};c._afterColumnCreate=function(d){this._applyRenderersToColumnElement(d);
this._columnElements.push(d)};c._afterColumnRemoved=function(d){d=this._columnElements.indexOf(d,0);-1<d&&this._columnElements.splice(d,1)};c._syncColumnRenderers=function(){this._columnElements.forEach(d=>{this._applyRenderersToColumnElement(d)})};c._appendStyles=function(){const d=this._grid?.shadowRoot,e=document.createElement("style");e.textContent=`\n      :host { ${this._hostStyles} }\n      [part~="header-cell"] ::slotted(vaadin-grid-cell-content) { ${this._headerStyles} }\n      [part~="row"]:hover [part~="body-cell"] { ${this._rowHoverStyles} }\n    `;
d?.appendChild(e)};c._updateGridSize=function(){this._grid&&(this._grid.size=this.size||0,this.scheduleRender())};c._getActiveEditInfo=function(){return!this.columns||this.columns.length?[]:this.columns.filter(d=>"activeEditInfo"in d).map(d=>d.activeEditInfo).items};c._addGridEventListeners=function(){const d=this._grid;Ja.assertIsSome(d);this.handles.add([Ia.on(d,"click",e=>this._onRowClick(e)),Ia.on(d,"selected-items-changed",e=>this._onSelectionChange(e)),Ia.on(d,"sorter-changed",()=>this.notifyChange("sortOrders")),
Ia.on(d,"loading-changed",e=>{this._isDataLoaded||!1!==e.detail.value||(this._isDataLoaded=!0,this._selectRowsOnLoad())})])};c._onRowClick=function(d){var e=this._grid;Ja.assertIsSome(e);e=e.getEventContext(d);const {item:f,section:g}=e;f&&g&&"details"!==g&&"header"!==g&&this.emit("row-click",{context:e,native:d})};c._clearSelection=function(){this._grid&&(this.highlightIds.removeAll(),this._grid.selectedItems=[],this._grid.render())};c._selectRowsOnLoad=function(){const d=this._grid;if(d){var e=
d.selectedItems.slice();(this.highlightIds?.filter(f=>0>e.findIndex(g=>g.objectId===f))).forEach(f=>d.selectedItems.push(this.store?.getLocalItemByKey(f)||{objectId:f}));d.render()}};c._selectRows=function(d){const e=this._grid;if(e){var f=e.selectedItems.slice();d.filter(g=>0>f.findIndex(h=>h.objectId===g.objectId)).forEach(g=>e.selectedItems.push(g));e.render()}};c._deselectRows=function(d){const e=this._grid;if(e){var f=e.selectedItems.slice();d.forEach(g=>{const h=f.findIndex(k=>k.objectId===
g.objectId);-1<h&&f.splice(h,1)});e.selectedItems=f;e.render()}};c._onSelectionChange=function(d){if("selectedItems.splices"===d.detail.path){const {removed:e,object:f}=d.detail.value.indexSplices[0];d=f.filter(h=>!this.highlightIds.includes(h.objectId)).map(h=>h.objectId);const g=e.filter(h=>this.highlightIds.includes(h.objectId)).map(h=>h.objectId);this.highlightIds.removeMany(g);this.highlightIds.addMany(d)}};c._applyRenderersToColumnElement=function(d){var e=d.getAttribute("path");if(e=this.viewModel.findColumn(e))try{const {renderFunction:f,
footerRenderFunction:g,headerRenderFunction:h}=e;f&&"renderer"in d&&(d.renderer=(k,l,m)=>f({root:k,column:l,rowData:m}));g&&(d.footerRenderer=(k,l)=>g({root:k,column:l}));h&&(d.headerRenderer=(k,l)=>h({root:k,column:l}))}catch(f){}};ib._createClass(a,[{key:"cellClassNameGenerator",get:function(){return this.viewModel.cellClassNameGenerator},set:function(d){this.viewModel.cellClassNameGenerator=d}},{key:"columns",get:function(){return this.viewModel.columns},set:function(d){this.viewModel.columns=
d}},{key:"columnReorderingEnabled",get:function(){return this.viewModel.columnReorderingEnabled},set:function(d){this.viewModel.columnReorderingEnabled=d}},{key:"dataProvider",get:function(){return this.viewModel.dataProvider},set:function(d){this.viewModel.dataProvider=d}},{key:"highlightIds",get:function(){return this.viewModel.highlightIds},set:function(d){this.viewModel.highlightIds=d}},{key:"label",get:function(){return this.messages?.widgetLabel??""},set:function(d){this._overrideIfSome("label",
d)}},{key:"multiSortEnabled",get:function(){return this.viewModel.multiSortEnabled},set:function(d){this.viewModel.multiSortEnabled=d}},{key:"pageSize",get:function(){return this.viewModel.pageSize},set:function(d){this.viewModel.pageSize=d}},{key:"rowDetailsRenderer",get:function(){return this.viewModel.rowDetailsRenderer},set:function(d){this.viewModel.rowDetailsRenderer=d}},{key:"size",get:function(){return this.viewModel.size}},{key:"sortOrders",get:function(){return this._grid?._sorters?this._grid._sorters.filter(d=>
!!d).map(({direction:d,path:e})=>({direction:d,path:e})):[]}},{key:"store",get:function(){return this.viewModel.store},set:function(d){this.viewModel.store=d}}]);return a}(ae.HandleOwnerMixin(de));y.__decorate([z.property()],x.prototype,"_grid",void 0);y.__decorate([z.property()],x.prototype,"_isDataLoaded",void 0);y.__decorate([z.property()],x.prototype,"cellClassNameGenerator",null);y.__decorate([z.property()],x.prototype,"columns",null);y.__decorate([z.property()],x.prototype,"columnReorderingEnabled",
null);y.__decorate([z.property()],x.prototype,"dataProvider",null);y.__decorate([z.property()],x.prototype,"highlightIds",null);y.__decorate([z.property()],x.prototype,"itemIdPath",void 0);y.__decorate([z.property()],x.prototype,"label",null);y.__decorate([z.property(),ge.messageBundle("esri/widgets/FeatureTable/t9n/FeatureTable")],x.prototype,"messages",void 0);y.__decorate([z.property()],x.prototype,"multiSortEnabled",null);y.__decorate([z.property()],x.prototype,"pageSize",null);y.__decorate([z.property()],
x.prototype,"rowDetailsRenderer",null);y.__decorate([z.property()],x.prototype,"size",null);y.__decorate([z.property({readOnly:!0})],x.prototype,"sortOrders",null);y.__decorate([z.property()],x.prototype,"store",null);y.__decorate([z.property()],x.prototype,"viewModel",void 0);y.__decorate([z.property()],x.prototype,"visibleElements",void 0);y.__decorate([be.cast("visibleElements")],x.prototype,"castVisibleElements",null);return x=y.__decorate([ce.subclass("esri.widgets.FeatureTable.Grid.Grid")],
x)});